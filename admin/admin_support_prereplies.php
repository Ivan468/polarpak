...
*/
	...
	if ($db->next_record()) {
		...
		do {
			...
			$reply_types[] = array($type_id, $type_name . " (".$type_replies.")");
	...
	$s->set_sorter(ID_MSG, "sorter_reply_id", "1", "sp.reply_id", "", "", true);
	$s->set_sorter(ADMIN_TITLE_MSG, "sorter_subject", "2", "sp.subject");
	$s->set_sorter(RATING_MSG, "sorter_uses", "3", "sp.total_uses");
