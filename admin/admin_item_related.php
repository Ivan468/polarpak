...
*/
	...
	set_session("related_url", "admin_item_related.php");
	...
	$list->set_leaves('items', 'item_id', 'item_name', 'items_categories', '(lv.is_draft=0 OR lv.is_draft IS NULL)');
