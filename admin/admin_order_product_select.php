...
*/
	...
	$sql .= " i.buying_price, i.price, i.weight, i.is_sales, i.sales_price, i.tax_id, i.tax_free, i.stock_level, i.use_stock_level, i.shipping_cost ";
	$sql .= " FROM ";
	if ($multisites_version) {
		$sql .= "(";
	}
	...
	if ($db->next_record()) {
		...
		do {
			...
			$t->set_var("tax_id", number_format($tax_id, 0));
			...
			$t->set_var("shipping_cost", number_format($shipping_cost, 2, ".", ""));
