...
*/
	...
	$s->set_sorter(SUMMARY_MSG, "sorter_summary", "3", "summary");
	$s->set_sorter(RATING_MSG, "sorter_rating", "4", "approved");
	...
	$t->set_var("s_rt_search", htmlspecialchars($r->get_value("s_rt")));
	$t->set_var("s_rc_search", htmlspecialchars($r->get_value("s_rc")));
