...
*/
	...
	if (comp_vers("3.5.22", $current_db_version) == 1) {
		...
		$sqls[] = $sql_types[$db_type];
		$sqls[] = " UPDATE " . $table_prefix . "currencies SET is_default_show=1 ";
		...
		$sqls[] = $sql_types[$db_type];                                               
		$sqls[] = " UPDATE " . $table_prefix . "shipping_modules SET is_call_center=1 ";
		...
		$sqls[] = $sql_types[$db_type];
		$sqls[] = " UPDATE " . $table_prefix . "shipping_types SET is_call_center=1 ";
