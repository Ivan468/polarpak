...
/*
  ...
  ***                                                                      ***
  ***      Viart Shop 5.6                                                  ***
  ***      File:  admin_saved_cart_notify.php                              ***
...
*/
  ...
  $t->set_file("main","admin_saved_cart_notify.html");
	...
	$r->add_textbox("reminder_from", TEXT);
	$r->add_textbox("reminder_cc", TEXT);
	$r->add_textbox("reminder_bcc", TEXT);
	$r->add_textbox("reminder_reply_to", TEXT);
	$r->add_textbox("reminder_return_path", TEXT);
	$r->add_textbox("reminder_subject", TEXT);
	$r->add_radio("reminder_mail_type", TEXT, $message_types);
	$r->add_textbox("reminder_body", TEXT);
	...
	$tabs = array(
			"saved_cart" => array("title" => SAVED_CART_NOTIFICATION_MSG), 
			"reminder" => array("title" => CART_REMINDER_NOTIFICATION_MSG), 
		);
