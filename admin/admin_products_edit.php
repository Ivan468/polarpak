...
*/
  ...
  $table_alias = "i";
    ...
    "item_order" => PROD_ORDER_MSG,
		...
		"packages_number" => PACKAGES_NUMBER_MSG, 
    "weight" => WEIGHT_MSG,
		"width" => WIDTH_MSG, 
		"height" => HEIGHT_MSG, 
		"length" => LENGTH_MSG, 
...
else
{
	  	...
	  	while($db->next_record())
		  {
		    ...
		    $eg->values[$number_items]["is_approved"] = $db->f("is_approved");
			  ...
			  $eg->values[$number_items]["packages_number"] = $db->f("packages_number");
			  $eg->values[$number_items]["weight"] = $db->f("weight");
			  $eg->values[$number_items]["width"] = $db->f("width");
			  $eg->values[$number_items]["height"] = $db->f("height");
			  $eg->values[$number_items]["length"] = $db->f("length");
			  ...
			  $eg->values[$number_items]["highlights"] = $db->f("highlights");
