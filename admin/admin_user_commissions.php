...
*/
	...
	for($i = 0; $i < sizeof($types); $i++) {
		...
		$commissions_today = doubleval(get_db_value($sql));
		...
		$commissions_yesterday = doubleval(get_db_value($sql));
		...
		$commissions_week = doubleval(get_db_value($sql));
		...
		$commissions_month = doubleval(get_db_value($sql));
