...
*/
	...
	$va_trail = array(
		"admin_menu.php?code=settings" => SETTINGS_MSG,
		"admin_menu.php?code=users-settings" => CUSTOMERS_MSG,
		"admin_user_types.php" => USERS_TYPES_MSG,
		"admin_user_type.php?type_id=".urlencode($type_id) => $type_name,
		"admin_user_profile.php?type_id=".urlencode($type_id) => PROFILE_SETTINGS_MSG,
	);
	...
	$editors_list = 'am,um,apu_msg,upu_msg,ubm,urm';
	...
	$r->add_textbox("middle_name_order", INTEGER);
	...
	$r->add_textbox("address3_order", INTEGER);
	...
	$r->add_textbox("delivery_middle_name_order", INTEGER);
	...
	$r->add_textbox("delivery_address3_order", INTEGER);
	...
	$r->add_textbox("birth_date_order", INTEGER);
	...
	$r->add_checkbox("admin_update_notification", INTEGER);
	$r->add_textbox("admin_update_to", TEXT);
	$r->add_textbox("admin_update_from", TEXT);
	$r->add_textbox("admin_update_cc", TEXT);
	$r->add_textbox("admin_update_bcc", TEXT);
	$r->add_textbox("admin_update_reply_to", TEXT);
	$r->add_textbox("admin_update_return_path", TEXT);
	$r->add_textbox("admin_update_subject", TEXT);
	$r->add_radio("admin_update_message_type", TEXT, $message_types);
	$r->add_textbox("admin_update_message", TEXT);

	$r->add_checkbox("user_update_notification", INTEGER);
	$r->add_textbox("user_update_from", TEXT);
	$r->add_textbox("user_update_cc", TEXT);
	$r->add_textbox("user_update_bcc", TEXT);
	$r->add_textbox("user_update_reply_to", TEXT);
	$r->add_textbox("user_update_return_path", TEXT);
	$r->add_textbox("user_update_subject", TEXT);
	$r->add_radio("user_update_message_type", TEXT, $message_types);
	$r->add_textbox("user_update_message", TEXT);

	// sms notification settings
	$r->add_checkbox("admin_update_sms_notification", INTEGER);
	$r->add_textbox("admin_update_sms_recipient", TEXT, ADMIN_SMS_RECIPIENT_MSG);
	$r->add_textbox("admin_update_sms_originator", TEXT, ADMIN_SMS_ORIGINATOR_MSG);
	$r->add_textbox("admin_update_sms_message", TEXT, ADMIN_SMS_MESSAGE_MSG);

	$r->add_checkbox("user_update_sms_notification", INTEGER);
	$r->add_textbox("user_update_sms_recipient", TEXT, USER_SMS_RECIPIENT_MSG);
	$r->add_textbox("user_update_sms_originator", TEXT, USER_SMS_ORIGINATOR_MSG);
	$r->add_textbox("user_update_sms_message", TEXT, USER_SMS_MESSAGE_MSG);
	...
	$tabs = array(
		...
		"custom_fields" => array("title" => va_constant("CUSTOM_FIELDS_MSG")),
		"registration_notify" => array("title" => va_constant("REGITRATION_NOTIFY_MSG")), 
		"update_notice" => array("title" => va_constant("PROFILE_UPDATE_NOTICE_MSG")), 
		"birthday_greetings" => array("title" => va_constant("BIRTHDAY_GREETINGS_MSG")), 
		"reminder_service" => array("title" => va_constant("REMINDER_SERVICE_MSG")),
	);
