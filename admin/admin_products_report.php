...
*/
	...
	if ($operation == "filter") {
		...
		$sql  = " SELECT i.item_id, i.item_code, i.manufacturer_code, i.item_name, i.price, i.is_sales, ";
		$sql .= " i.sales_price, i.stock_level, c.category_id";
 		$sql .= " FROM ((" . $join_prep . " " . $table_prefix . "items i ";
