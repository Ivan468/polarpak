...
*/
	...
	$pd_types =
		array(
			array("1and1", POSITIVE_REVIEW_MSG . " & " . NEGATIVE_REVIEW_MSG), array("latest", LATEST_REVIEWS_MSG),
		);
	...
	// reviews settings on articles details page
	$r->add_radio("pd_type", TEXT, $pd_types);		
	$r->add_textbox("pd_reviews_recs", INTEGER, ucwords(ON_PROD_DETAILS_MSG).": ".REVIEWS_PER_PAGE_MSG);
	...
	$r->add_textbox("comments_order", INTEGER, YOUR_REVIEW_MSG);
