...
$messages = array(
	...
	"GOOD_MSG" => "جيد",
	"EXCELLENT_MSG" => "ممتاز",
	"REVIEWS_MSG" => "التعليقات",
	"NO_REVIEWS_MSG" => "لا توجد اية تعليقات",
	"WRITE_REVIEW_MSG" => "اضف تعليقاً",
	"WRITE_REVIEW_SIGN_IN_MSG" => "Sign in to write a review",
	"RATE_PRODUCT_MSG" => "قَيِم هذا المنتج",
	"RATE_ARTICLE_MSG" => "قَيِم هذا الموضوع",
	"NOT_RATED_PRODUCT_MSG" => ".لم يتم تقييم هذا المنتج بعد",
	"NOT_RATED_ARTICLE_MSG" => ".لم يتم تقييم هذه الموضوع بعد",
	"AVERAGE_RATING_MSG" => "متوسط التقييمات",
	"BASED_ON_REVIEWS_MSG" => "{total_votes} :بالإعتماد على عدد التعليقات",
	"SEE_ALL_REVIEWS_MSG" => "اطلع على جميع التعليقات",
	"ALL_REVIEWS_MSG" => "كل التعليقات",
	"ONLY_POSITIVE_MSG" => "الإيجابيه فقط",
	"ONLY_NEGATIVE_MSG" => "السلبيه فقط",
	"POSITIVE_REVIEWS_MSG" => "التعليقات الإيجابيه",
	"NEGATIVE_REVIEWS_MSG" => "التعليقات السلبيه",
	"NEUTRAL_REVIEWS_MSG" => "Neutral Reviews",
	"REVIEW_SAVED_MSG" => "Thank you, your review has been saved.",
	"REVIEW_SAVED_FOR_APPROVAL_MSG" => ".ستتم مراجعة تعليقك, و سيتم نشره اذا تمت الموافقه عليه. لاحظ اننا نملك الحق في رفض اية تعليق لا يتوافق مع متطلباتنا <br>شكراً لك",
	"ALREADY_REVIEWED_MSG" => "لقد قمت مسبقاً بوضع تعليقك",
	"ALREADY_REVIEWED_PRODUCT_MSG" => "You have already placed a review for this product.",
	"RECOMMEND_PRODUCT_MSG" => "هل تنصح بهذا المنتج للآخرين؟",
	"RECOMMEND_ARTICLE_MSG" => "هل تنصح هذا الموضوع للآخرين؟",
	...
	"RATE_IT_MSG" => "قيمه",
	"NAME_ALIAS_MSG" => "الإسم او الإسم المستعار",
	...
	"NO_QUESTIONS_MSG" => "لم يتم ايجاد اية اسئله",
	...
	"QUESTION_SAVED_FOR_APPROVAL_MSG" => ".ستتم مراجعة تعليقك, و سيتم نشره اذا تمت الموافقه عليه. لاحظ اننا نملك الحق في رفض اية تعليق لا يتوافق مع متطلباتنا <br>شكراً لك",
	"ALREADY_ASKED_MSG" => "لقد قمت مسبقاً بوضع تعليقك",
