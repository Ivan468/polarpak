...
$messages = array(
	// støttemeldinger
	"SUPPORT_TITLE" => "Støtteavdeling",
	"SUPPORT_REQUEST_INF_TITLE" => "Be om informasjon",
	"SUPPORT_REPLY_FORM_TITLE" => "Svar",
	"SUPPORT_SHORT_TITLE" => "Support",

	"MY_SUPPORT_ISSUES_MSG" => "Mine støttesaker",
	"MY_SUPPORT_ISSUES_DESC" => "Hvis du opplever problemer med varen du har kjøpt, er vår støtteavdeling klar for å hjelpe deg.  Ved å trykke på lenken ovenfor kan du kontakte oss og opprette en støttesak.",
	"NEW_SUPPORT_REQUEST_MSG" => "Ny forespørsel",
	"SUPPORT_REQUEST_ADDED_MSG" => "Takk<br>Vår supportavdeling vil hjelpe deg så fort som mulig.",
	"SUPPORT_SELECT_DEP_MSG" => "Velg avdeling",
	"SUPPORT_SELECT_PROD_MSG" => "Velg produkt",
	"SUPPORT_SELECT_STATUS_MSG" => "Velg status",
	"SUPPORT_NOT_VIEWED_MSG" => "Ikke sett",
	"SUPPORT_VIEWED_BY_USER_MSG" => "Sett av kunde",
	"SUPPORT_VIEWED_BY_ADMIN_MSG" => "Sett av administrator",
	"SUPPORT_STATUS_NEW_MSG" => "Ny",
	"NO_SUPPORT_REQUEST_MSG" => "Ingen utgivelser ble funnet",

	"SUPPORT_SUMMARY_COLUMN" => "Oppsummering",
	"SUPPORT_TYPE_COLUMN" => "Type",
	"SUPPORT_UPDATED_COLUMN" => "Sist oppdatert",

	"SUPPORT_USER_NAME_FIELD" => "Ditt navn",
	"SUPPORT_USER_EMAIL_FIELD" => "Din e-mail adresse",
	"SUPPORT_IDENTIFIER_FIELD" => "Identifikator (Faktura #)",
	"SUPPORT_ENVIRONMENT_FIELD" => "Omgivelse (OS, Database, Web Server, etc.)",
	"SUPPORT_DEPARTMENT_FIELD" => "Avdeling",
	"SUPPORT_PRODUCT_FIELD" => "Vare",
	"SUPPORT_TYPE_FIELD" => "Type",
	"SUPPORT_CURRENT_STATUS_FIELD" => "Foreløpig status",
	"SUPPORT_SUMMARY_FIELD" => "Oppsummering på en linje",
	"SUPPORT_DESCRIPTION_FIELD" => "Beskrivelse",
	"SUPPORT_MESSAGE_FIELD" => "Melding",
	"SUPPORT_ADDED_FIELD" => "Lagt til",
	"SUPPORT_ADDED_BY_FIELD" => "Lagt til av",
	"SUPPORT_UPDATED_FIELD" => "Sist oppdatert",

	"SUPPORT_REQUEST_BUTTON" => "Send forspørsel",
	                                    
	"SUPPORT_MISS_ID_ERROR" => "Mangler <b>Support ID</b> parameter",
	"SUPPORT_MISS_CODE_ERROR" => "Mangler <b>Verification</b> parameter",
	"SUPPORT_WRONG_ID_ERROR" => "<b>Support ID</b> parameter har feil verdi",
	"SUPPORT_WRONG_CODE_ERROR" => "<b>Verification</b> parameter har feil verdi",

	"MAIL_DATA_MSG" => "Postdata",
	"HEADERS_MSG" => "Topper",
	"ORIGINAL_TEXT_MSG" => "Original tekst",
