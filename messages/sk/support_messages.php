...
$messages = array(
	...
	"SUPPORT_REQUEST_INF_TITLE" => "Žiadosť o informáciu",
	"SUPPORT_REPLY_FORM_TITLE" => "Odpovedať",
	"SUPPORT_SHORT_TITLE" => "Support",

	"MY_SUPPORT_ISSUES_MSG" => "Moje žiadosti o podporu",
	"MY_SUPPORT_ISSUES_DESC" => "Ak máte akékoľvek problémy s produktami, ktoré ste u nás zakúpili, náš tím podpory zákazníkom je pripravený Vám pomôcť. Pre zadanie požiadavky stačí kliknúť na hornú linku",
	"NEW_SUPPORT_REQUEST_MSG" => "Nová požiadavka",
	"SUPPORT_REQUEST_ADDED_MSG" => "Ďakujeme<br>Náš tím podpory sa pokúsi pomôcť s Vašou požiadavkou tak rýchlo, ako to len bude možné.",
	"SUPPORT_SELECT_DEP_MSG" => "Zvoliť oddelenie",
	"SUPPORT_SELECT_PROD_MSG" => "Zvoliť produkt",
	"SUPPORT_SELECT_STATUS_MSG" => "Zvoliť stav",
	"SUPPORT_NOT_VIEWED_MSG" => "Neprezreté",
	"SUPPORT_VIEWED_BY_USER_MSG" => "Prezreté zákazníkom",
	"SUPPORT_VIEWED_BY_ADMIN_MSG" => "Prezreté administrátorom",
	"SUPPORT_STATUS_NEW_MSG" => "Nová",
	"NO_SUPPORT_REQUEST_MSG" => "Žiadne dotazy nenájdené",

	"SUPPORT_SUMMARY_COLUMN" => "Sumár",
	"SUPPORT_TYPE_COLUMN" => "Typ",
	"SUPPORT_UPDATED_COLUMN" => "Naposledy aktualizované",

	"SUPPORT_USER_NAME_FIELD" => "Vaše meno",
	"SUPPORT_USER_EMAIL_FIELD" => "Vaša emailová adresa",
	"SUPPORT_IDENTIFIER_FIELD" => "Identifikátor (číslo faktúry)",
	"SUPPORT_ENVIRONMENT_FIELD" => "Prostredie (OS, Databáza, Web Server, atď.)",
	"SUPPORT_DEPARTMENT_FIELD" => "Oddelenie",
	"SUPPORT_PRODUCT_FIELD" => "Produkt",
	"SUPPORT_TYPE_FIELD" => "Typ",
	"SUPPORT_CURRENT_STATUS_FIELD" => "Momentálny status",
	"SUPPORT_SUMMARY_FIELD" => "Jednoriadkový sumár",
	"SUPPORT_DESCRIPTION_FIELD" => "Popis",
	"SUPPORT_MESSAGE_FIELD" => "Správa",
	"SUPPORT_ADDED_FIELD" => "Pridaný",
	"SUPPORT_ADDED_BY_FIELD" => "Pridal",
	"SUPPORT_UPDATED_FIELD" => "Naposledy aktualizované",

	"SUPPORT_REQUEST_BUTTON" => "Odoslať požiadavku",
	                                    
	"SUPPORT_MISS_ID_ERROR" => "Chýba <b>Podpora ID</b> parameter",
	"SUPPORT_MISS_CODE_ERROR" => "Chýba <b>kontrolný</b> parameter",
	"SUPPORT_WRONG_ID_ERROR" => "<b>Podpora ID</b> parameter má nesprávnu hodnotu",
	"SUPPORT_WRONG_CODE_ERROR" => "<b>Kontrolný</b> parameter má nesprávnu hodnotu",
