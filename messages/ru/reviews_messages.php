...
$messages = array(
	...
	"REVIEWS_MSG" => "Отзывы",
	"NO_REVIEWS_MSG" => "Отзывы не найдены",
	"WRITE_REVIEW_MSG" => "Напишите отзыв",
	"WRITE_REVIEW_SIGN_IN_MSG" => "Sign in to write a review",
	"RATE_PRODUCT_MSG" => "Оцените продукт",
	"RATE_ARTICLE_MSG" => "Оцените продукт",
	"NOT_RATED_PRODUCT_MSG" => "Пока нет отзывов и оценок",
	"NOT_RATED_ARTICLE_MSG" => "Пока нет отзывов и оценок",
	"AVERAGE_RATING_MSG" => "Средний Рейтинг",
	"BASED_ON_REVIEWS_MSG" => "основан на {total_votes} отзывах",
	"SEE_ALL_REVIEWS_MSG" => "См. все отзывы пользователей",
	"ALL_REVIEWS_MSG" => "Все отзывы",
	"ONLY_POSITIVE_MSG" => "Только положительные",
	"ONLY_NEGATIVE_MSG" => "Только отрицательные",
	"POSITIVE_REVIEWS_MSG" => "Положительные отзывы",
	"NEGATIVE_REVIEWS_MSG" => "Отрицательные отзывы",
	"NEUTRAL_REVIEWS_MSG" => "Neutral Reviews",
	"REVIEW_SAVED_MSG" => "Thank you, your review has been saved.",
	"REVIEW_SAVED_FOR_APPROVAL_MSG" => "Спасибо! <br/>Ваш отзыв появится сразу после проверки Модератором на соответствие нашим правилам. <br> Мы сохраняем за собой право отклонять любые сообщения, которые содержат не нормативную лексику, спам и т.п.",
	"ALREADY_REVIEWED_MSG" => "Вы уже добавили отзыв.",
	"ALREADY_REVIEWED_PRODUCT_MSG" => "You have already placed a review for this product.",
	"RECOMMEND_PRODUCT_MSG" => "Вы бы порекомендовали этот продукт другим?",
	"RECOMMEND_ARTICLE_MSG" => "Вы бы порекомендовали эту статью другим?",
	...
	"RATE_IT_MSG" => "Оцените",
	"NAME_ALIAS_MSG" => "Имя или псевдоним",
	"YOUR_COMMENTS_MSG" => "Your comments",
	"SHOW_MSG" => "Показать",
	"FOUND_MSG" => "Найдено",
	"REGISTERED_USERS_ADD_REVIEWS_MSG" => "Только зарегистрированные пользователи могут оставлять отзывы и комментарии",
	"NOT_ALLOWED_ADD_REVIEW_MSG" => "Извините, но у вас нет доступа к отзывам.",
	...
	"AUTO_PUBLISH_REVIEWS_MSG" => "Публиковать отзывы без проверки автоматически",
	"APPROVE_BEFORE_PUBLISHING_ON_SITE_MSG" => "Administrator should approve reviews before publishing on the site",
	"BY_RATING_MSG" => "Рейтинг",
	"SELECT_REVIEWS_FIRST_MSG" => "Пожалуйста, выберите отзывы.",
	"SELECT_REVIEWS_STATUS_MSG" => "Пожалуйста, выберите статус.",
	"REVIEWS_STATUS_CONFIRM_MSG" => "Вы собираетесь изменить статус отзыва(ов) для '{status_name}'. Продолжить?",
	"REVIEWS_DELETE_CONFIRM_MSG" => "Вы уверены, что хотите удалить ({total_reviews}) отзывов?",
	"SEND_REPLIES_TO_EMAIL_MSG" => "Send all replies to my email",
	"REVIEWS_RESTRICTIONS_MSG" => "Ограничения отзывов",
	"ALLOWED_VIEW_REVIEWS_MSG" => "Разрешить просмотр отзывов",
	"ALLOWED_POST_REVIEWS_MSG" => "Разрешить оставлять отзывы",
	"ALLOWED_LIKE_MSG" => "Allowed to Like",
	"ALLOWED_DISLIKE_MSG" => "Allowed to Disike",
	"REVIEWS_PER_PRODUCT_MSG" => "Кол-во отзывов от пользователя",
	"REVIEWS_PER_PRODUCT_DESC" => "оставьте это поле пустым, если не хотите ограничивать кол-во отзывов от одного пользователя",
	"REVIEWS_PER_ARTICLE_MSG" => "Кол-во отзывов от пользователя",
	"REVIEWS_PER_ARTICLE_DESC" => "оставьте это поле пустым, если не хотите ограничивать кол-во отзывов от одного пользователя",
	"REVIEWS_PERIOD_MSG" => "Период ограничения для отзывов",
	"REVIEWS_PERIOD_DESC" => "период, в течении которого пользователь не сможет оставить повторный отзыв",
	...
	"COMMENTS_PER_REVIEW_MSG" => "Кол-во отзывов от пользователя",
	"COMMENTS_PER_REVIEW_DESC" => "оставьте это поле пустым, если не хотите ограничивать кол-во отзывов от одного пользователя",
	"COMMENTS_PERIOD_MSG" => "Период ограничения для отзывов",
	"COMMENTS_PERIOD_DESC" => "период, в течении которого пользователь не сможет оставить повторный отзыв",
	...
	"NO_QUESTIONS_MSG" => "Ни одного вопроса не найдено",
	...
	"QUESTION_SAVED_FOR_APPROVAL_MSG" => "Спасибо! <br/>Ваш отзыв появится сразу после проверки Модератором на соответствие нашим правилам. <br> Мы сохраняем за собой право отклонять любые сообщения, которые содержат не нормативную лексику, спам и т.п.",
	"ALREADY_ASKED_MSG" => "Вы уже добавили отзыв.",
