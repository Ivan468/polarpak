...
$messages = array(
	// apžvalgų/vertinimo žinutės
	"OPTIONAL_MSG" => "Nebūtinas",
	"RATING_MSG" => "Rating",
	"BAD_MSG" => "Blogas",
	"POOR_MSG" => "Silpnas",
	"AVERAGE_MSG" => "Vidutinis",
	"GOOD_MSG" => "Geras",
	"EXCELLENT_MSG" => "Puikus",
	"REVIEWS_MSG" => "Apžvalgos",
	"NO_REVIEWS_MSG" => "Apžvalgų nerasta",
	"WRITE_REVIEW_MSG" => "Rašykite apžvalgą",
	"WRITE_REVIEW_SIGN_IN_MSG" => "Sign in to write a review",
	"RATE_PRODUCT_MSG" => "Įvertinkite prekę",
	"RATE_ARTICLE_MSG" => "Įvertinkite šį straipsnį",
	"NOT_RATED_PRODUCT_MSG" => "Prekė dar neįvertinta",
	"NOT_RATED_ARTICLE_MSG" => "Straipsnis dar neįvertintas",
	"AVERAGE_RATING_MSG" => "Vidutinis įvertinimas",
	"BASED_ON_REVIEWS_MSG" => "Pagrįsta {total_votes} apžvalgomis",
	"SEE_ALL_REVIEWS_MSG" => "Žiūrėkite visas klientų apžvalgas..",
	"ALL_REVIEWS_MSG" => "Visos apžvlagos",
	"ONLY_POSITIVE_MSG" => "Tik teigiamos",
	"ONLY_NEGATIVE_MSG" => "Tik neigiamos",
	"POSITIVE_REVIEWS_MSG" => "Teigiamos apžvalgos",
	"NEGATIVE_REVIEWS_MSG" => "Neigiamos apžvalgos",
	"NEUTRAL_REVIEWS_MSG" => "Neutral Reviews",
	"REVIEW_SAVED_MSG" => "Thank you, your review has been saved.",
	"REVIEW_SAVED_FOR_APPROVAL_MSG" => "Ačiū Jums<br>Jūsų pastabos bus peržiūrėtos. Jei bus patvirtintos jos pasirodys mūsų svetainėje.<br>Mes pasiliekam teisę atmesti bet kokius siuntimus kurie netinka mūsų nuostatoms.",
	"ALREADY_REVIEWED_MSG" => "Jūs jau įdėjote savo apžvalgą.",
	"ALREADY_REVIEWED_PRODUCT_MSG" => "You have already placed a review for this product.",
	"RECOMMEND_PRODUCT_MSG" => "Ar Jūs patarsite<br> šią prekę kitiems?",
	"RECOMMEND_ARTICLE_MSG" => "Ar Jūs patarsite<br> šį straipsnį kitiems?",
	...
	"RATE_IT_MSG" => "Įvertinkite jį",
	"NAME_ALIAS_MSG" => "Vardas arba slapyvardis",
	...
	"NO_QUESTIONS_MSG" => "nerasta nei vieno klausimo",
	...
	"QUESTION_SAVED_FOR_APPROVAL_MSG" => "Ačiū Jums<br>Jūsų pastabos bus peržiūrėtos. Jei bus patvirtintos jos pasirodys mūsų svetainėje.<br>Mes pasiliekam teisę atmesti bet kokius siuntimus kurie netinka mūsų nuostatoms.",
	"ALREADY_ASKED_MSG" => "Jūs jau įdėjote savo apžvalgą.",
