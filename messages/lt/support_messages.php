...
$messages = array(
	// palaikymo žinutės
	"SUPPORT_TITLE" => "Palaikymo būstinė",
	"SUPPORT_REQUEST_INF_TITLE" => "Užklausti žinių",
	"SUPPORT_REPLY_FORM_TITLE" => "Atsakyti",
	"SUPPORT_SHORT_TITLE" => "Support",

	"MY_SUPPORT_ISSUES_MSG" => "Mano palaikymo užklausimai",
	"MY_SUPPORT_ISSUES_DESC" => "Jei Jūs susiduriate su bėdomis dėl prekių kurias pirkote, mūsų palaikymo grupė pasiruošus padėti. Jauskitės laisvi susisiekti su mumis, spausdami nuorodą kad pasiųsti Palaikymo Užklausimą.",
	"NEW_SUPPORT_REQUEST_MSG" => "Naujas Užklausimas",
	"SUPPORT_REQUEST_ADDED_MSG" => "Ačiū Jums<br>Mūsų Palaikymo grupė stengsis jums padėti kaip galima greičiau dėl jūsų Užklausimo.",
	"SUPPORT_SELECT_DEP_MSG" => "Rinkitės skyrių",
	"SUPPORT_SELECT_PROD_MSG" => "Rinkitės prekę",
	"SUPPORT_SELECT_STATUS_MSG" => "Rinkitės stovį",
	"SUPPORT_NOT_VIEWED_MSG" => "Neperžiūrėta",
	"SUPPORT_VIEWED_BY_USER_MSG" => "Žiūrėta kliento",
	"SUPPORT_VIEWED_BY_ADMIN_MSG" => "Žiūrėta valdytojo",
	"SUPPORT_STATUS_NEW_MSG" => "Nauja",
	"NO_SUPPORT_REQUEST_MSG" => "Klausimų nerasta",

	"SUPPORT_SUMMARY_COLUMN" => "Suvestinė",
	"SUPPORT_TYPE_COLUMN" => "Tipas",
	"SUPPORT_UPDATED_COLUMN" => "Paskutinis atnaujinimas",

	"SUPPORT_USER_NAME_FIELD" => "Jūsų vardas",
	"SUPPORT_USER_EMAIL_FIELD" => "Jūsų e-pašto adresas",
	"SUPPORT_IDENTIFIER_FIELD" => "Identifikatorius (sąskaitos nr.)",
	"SUPPORT_ENVIRONMENT_FIELD" => "Aplinka (OS, Duombazė, Tinklo serveris, ir pan.)",
	"SUPPORT_DEPARTMENT_FIELD" => "Skyrius",
	"SUPPORT_PRODUCT_FIELD" => "Prekė",
	"SUPPORT_TYPE_FIELD" => "Tipas",
	"SUPPORT_CURRENT_STATUS_FIELD" => "Esamas stovis",
	"SUPPORT_SUMMARY_FIELD" => "Vienos-eilutės suvestinė",
	"SUPPORT_DESCRIPTION_FIELD" => "Aprašymas",
	"SUPPORT_MESSAGE_FIELD" => "Žinutė",
	"SUPPORT_ADDED_FIELD" => "Pridėta",
	"SUPPORT_ADDED_BY_FIELD" => "Pridėta kieno",
	"SUPPORT_UPDATED_FIELD" => "Paskutinis atnaujinimas",

	"SUPPORT_REQUEST_BUTTON" => "Teikti užklausimą",
	                                    
	"SUPPORT_MISS_ID_ERROR" => "Trūkstamas <b>Palaikymo ID</b> parametras",
	"SUPPORT_MISS_CODE_ERROR" => "Trūkstamas <b>Patikrinimo</b> parametras",
	"SUPPORT_WRONG_ID_ERROR" => "<b>Palaikymo ID</b> parametras turi blogą reikšmę",
	"SUPPORT_WRONG_CODE_ERROR" => "<b>Patikrinimo</b> parametras turi blogą reikšmę",
