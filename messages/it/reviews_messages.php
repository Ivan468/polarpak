...
$messages = array(
	...
	"OPTIONAL_MSG" => "Opzionale",
	"RATING_MSG" => "Rating",
	"BAD_MSG" => "Pessimo",
	"POOR_MSG" => "Scarso",
	"AVERAGE_MSG" => "Medio",
	"GOOD_MSG" => "Buono",
	"EXCELLENT_MSG" => "Eccelente",
	"REVIEWS_MSG" => "Pareri",
	"NO_REVIEWS_MSG" => "Nessun parere trovato",
	"WRITE_REVIEW_MSG" => "Scrivi un parere",
	"WRITE_REVIEW_SIGN_IN_MSG" => "Sign in to write a review",
	"RATE_PRODUCT_MSG" => "Valuta questo prodotto",
	"RATE_ARTICLE_MSG" => "Valuta questo articolo",
	"NOT_RATED_PRODUCT_MSG" => "Prodotto non ancora valutato",
	"NOT_RATED_ARTICLE_MSG" => "Articolo non ancora valutato",
	"AVERAGE_RATING_MSG" => "Valutazione media",
	"BASED_ON_REVIEWS_MSG" => "basato su {total_votes} pareri",
	"SEE_ALL_REVIEWS_MSG" => "Visualizza tutti i pareri dei clienti..",
	"ALL_REVIEWS_MSG" => "Tutti i pareri",
	"ONLY_POSITIVE_MSG" => "Solo Positivi",
	"ONLY_NEGATIVE_MSG" => "Solo Negativi",
	"POSITIVE_REVIEWS_MSG" => "Pareri Positivi",
	"NEGATIVE_REVIEWS_MSG" => "Pareri Negativi",
	"NEUTRAL_REVIEWS_MSG" => "Neutral Reviews",
	"REVIEW_SAVED_MSG" => "Thank you, your review has been saved.",
	"REVIEW_SAVED_FOR_APPROVAL_MSG" => "Grazie<br>I tuoi commenti saranno sottoposti a verifica. Se approvati appariranno sul nostro sito.<br>Ci riserviamo il diritto di togliere tutti i commenti non conformi alle nostre linee guida.",
	"ALREADY_REVIEWED_MSG" => "Hai gia' inserito un parere",
	"ALREADY_REVIEWED_PRODUCT_MSG" => "You have already placed a review for this product.",
	"RECOMMEND_PRODUCT_MSG" => "Desideri raccomandare<br>questo prodotto a qualcuno ?",
	"RECOMMEND_ARTICLE_MSG" => "Desideri raccomandare<br>questo articolo a qualcuno ?",
	...
	"RATE_IT_MSG" => "Valutalo",
	"NAME_ALIAS_MSG" => "Nome o Soprannome",
	...
	"NO_QUESTIONS_MSG" => "Nessuna domanda trovata",
	...
	"QUESTION_SAVED_FOR_APPROVAL_MSG" => "Grazie<br>I tuoi commenti saranno sottoposti a verifica. Se approvati appariranno sul nostro sito.<br>Ci riserviamo il diritto di togliere tutti i commenti non conformi alle nostre linee guida.",
	"ALREADY_ASKED_MSG" => "Hai gia' inserito un parere",
