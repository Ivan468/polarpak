...
$messages = array(
	...
	"SUPPORT_REQUEST_INF_TITLE" => "Richiesta informazioni",
	"SUPPORT_REPLY_FORM_TITLE" => "Risposta",
	"SUPPORT_SHORT_TITLE" => "Support",

	"MY_SUPPORT_ISSUES_MSG" => "Le mie richieste al supporto",
	"MY_SUPPORT_ISSUES_DESC" => "Se hai riscontrato qualche problema con i prodotti acquistati, il nostro Team di supporto e' pronto ad aiutarti. Contattalo premendo sul collegmamento sottostante per inviare la tua richiesta.",
	"NEW_SUPPORT_REQUEST_MSG" => "Nuova richiesta",
	"SUPPORT_REQUEST_ADDED_MSG" => "Grazie<br>Il nostro Team di supporto cerchera' di aiutarti il prima possibile.",
	"SUPPORT_SELECT_DEP_MSG" => "Seleziona il reparto",
	"SUPPORT_SELECT_PROD_MSG" => "Seleziona il prodotto",
	"SUPPORT_SELECT_STATUS_MSG" => "Selezione lo stato",
	"SUPPORT_NOT_VIEWED_MSG" => "Non visualizzato",
	"SUPPORT_VIEWED_BY_USER_MSG" => "Visualizzato dal cliente",
	"SUPPORT_VIEWED_BY_ADMIN_MSG" => "Visualizzato dall'amministratore",
	"SUPPORT_STATUS_NEW_MSG" => "Nuovo",
	"NO_SUPPORT_REQUEST_MSG" => "Nessuna richiesta  e' stata trovata",

	"SUPPORT_SUMMARY_COLUMN" => "Sommario",
	"SUPPORT_TYPE_COLUMN" => "Tipo",
	"SUPPORT_UPDATED_COLUMN" => "Ultimo aggiornato",

	"SUPPORT_USER_NAME_FIELD" => "Il tuo nome",
	"SUPPORT_USER_EMAIL_FIELD" => "Il tuo indirizzo email",
	"SUPPORT_IDENTIFIER_FIELD" => "Identificatore (Fattura #)",
	"SUPPORT_ENVIRONMENT_FIELD" => "Caratteristiche (OS, Database, Server Web, etc)",
	"SUPPORT_DEPARTMENT_FIELD" => "Reparto",
	"SUPPORT_PRODUCT_FIELD" => "Prodotto",
	"SUPPORT_TYPE_FIELD" => "Tipo",
	"SUPPORT_CURRENT_STATUS_FIELD" => "Stato Attuale",
	"SUPPORT_SUMMARY_FIELD" => "Sommario ",
	"SUPPORT_DESCRIPTION_FIELD" => "Descrizione",
	"SUPPORT_MESSAGE_FIELD" => "Messaggio",
	"SUPPORT_ADDED_FIELD" => "Aggiunto",
	"SUPPORT_ADDED_BY_FIELD" => "Aggiunto da",
	"SUPPORT_UPDATED_FIELD" => "Ultimo aggiornato",

	"SUPPORT_REQUEST_BUTTON" => "Invia una richiesta",
	                                    
	"SUPPORT_MISS_ID_ERROR" => "Il parametro <b>Support ID</b> e' mancante",
	"SUPPORT_MISS_CODE_ERROR" => "Il parametro <b>di verifica</b> e' mancante",
	"SUPPORT_WRONG_ID_ERROR" => "Il parametro <b>Support ID</b> ha valore errato",
	"SUPPORT_WRONG_CODE_ERROR" => "Il parametro <b> di verifica</b> ha valore errato",
