...
$messages = array(
	...
	"RATING_MSG" => "Classificação",
	"BAD_MSG" => "Mau",
	"POOR_MSG" => "Medíocre",
	"AVERAGE_MSG" => "Médio",
	"GOOD_MSG" => "Bom",
	"EXCELLENT_MSG" => "Excelente",
	"REVIEWS_MSG" => "Revisões",
	"NO_REVIEWS_MSG" => "Não foram encontradas revisões",
	"WRITE_REVIEW_MSG" => "Escreva uma revisão",
	"WRITE_REVIEW_SIGN_IN_MSG" => "Sign in to write a review",
	"RATE_PRODUCT_MSG" => "Classifique este produto",
	"RATE_ARTICLE_MSG" => "Classifique este artigo",
	"NOT_RATED_PRODUCT_MSG" => "O produto ainda não está classificado.",
	"NOT_RATED_ARTICLE_MSG" => "O artigo ainda não está classificado.",
	"AVERAGE_RATING_MSG" => "Classificação Média",
	"BASED_ON_REVIEWS_MSG" => "baseado em {total_votes} revisões",
	"SEE_ALL_REVIEWS_MSG" => "Ver todas as revisões do cliente...",
	"ALL_REVIEWS_MSG" => "Todas as Revisões",
	"ONLY_POSITIVE_MSG" => "Apenas as Positivas",
	"ONLY_NEGATIVE_MSG" => "Apenas as Negativas",
	"POSITIVE_REVIEWS_MSG" => "Revisões Positivas",
	"NEGATIVE_REVIEWS_MSG" => "Revisões Negativas",
	"NEUTRAL_REVIEWS_MSG" => "Neutral Reviews",
	"REVIEW_SAVED_MSG" => "Thank you, your review has been saved.",
	"REVIEW_SAVED_FOR_APPROVAL_MSG" => "Obrigado<br>Os seus comentários serão revistos. Se forem aprovados, serão mostrados no nosso site.<br>Reservamo-nos no direito de declinar qualquer submissões que não se enquadrem no âmbito deste site.",
	"ALREADY_REVIEWED_MSG" => "Já colocou uma revisão.",
	"ALREADY_REVIEWED_PRODUCT_MSG" => "You have already placed a review for this product.",
	"RECOMMEND_PRODUCT_MSG" => "Recomendaria<br> este produto a outros?",
	"RECOMMEND_ARTICLE_MSG" => "Recomendaria<br> este artigo a outros?",
	...
	"RATE_IT_MSG" => "Classifique-o",
	"NAME_ALIAS_MSG" => "Nome ou pseudónimo",
	...
	"NO_QUESTIONS_MSG" => "Não foram encontradas perguntas",
	...
	"QUESTION_SAVED_FOR_APPROVAL_MSG" => "Obrigado<br>Os seus comentários serão revistos. Se forem aprovados, serão mostrados no nosso site.<br>Reservamo-nos no direito de declinar qualquer submissões que não se enquadrem no âmbito deste site.",
	"ALREADY_ASKED_MSG" => "Já colocou uma revisão.",
