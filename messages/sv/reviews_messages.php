...
$messages = array(
	...
	"OPTIONAL_MSG" => "Valfritt",
	"RATING_MSG" => "Betygssättning",
	"BAD_MSG" => "Dålig",
	"POOR_MSG" => "Sådär",
	"AVERAGE_MSG" => "Medel",
	"GOOD_MSG" => "Bra",
	"EXCELLENT_MSG" => "Utmärkt",
	"REVIEWS_MSG" => "Recensioner",
	"NO_REVIEWS_MSG" => "Inga recensioner funna",
	"WRITE_REVIEW_MSG" => "Skriv en recension",
	"WRITE_REVIEW_SIGN_IN_MSG" => "Sign in to write a review",
	"RATE_PRODUCT_MSG" => "Betygsätt denna produkt",
	"RATE_ARTICLE_MSG" => "Betygsätt denna artikel",
	"NOT_RATED_PRODUCT_MSG" => "Produkten är inte betygsatt än.",
	"NOT_RATED_ARTICLE_MSG" => "Artikeln är inte betygsatt än.",
	"AVERAGE_RATING_MSG" => "Medelbetyg",
	"BASED_ON_REVIEWS_MSG" => "baserat på {total_votes} recensioner",
	"SEE_ALL_REVIEWS_MSG" => "Se alla kunders recensioner",
	"ALL_REVIEWS_MSG" => "Alla recensioner",
	"ONLY_POSITIVE_MSG" => "Endast positiva",
	"ONLY_NEGATIVE_MSG" => "Endast negativa",
	"POSITIVE_REVIEWS_MSG" => "Positiva recensioner",
	"NEGATIVE_REVIEWS_MSG" => "Negativa recensioner",
	"NEUTRAL_REVIEWS_MSG" => "Neutral Reviews",
	"REVIEW_SAVED_MSG" => "Thank you, your review has been saved.",
	"REVIEW_SAVED_FOR_APPROVAL_MSG" => "Tack så mycket!<br>Din kommentar kommer granskas. Om den godkänns kommer den snart synas på webbplatsen. <br>Vi reserverar rätten att neka insändare som inte möter våra riktlinjer.",
	"ALREADY_REVIEWED_MSG" => "Du har redan skrivit en recension.",
	"ALREADY_REVIEWED_PRODUCT_MSG" => "You have already placed a review for this product.",
	"RECOMMEND_PRODUCT_MSG" => "Kan du rekommendera<br> denna produkt till andra?",
	"RECOMMEND_ARTICLE_MSG" => "Kan du rekommendera<br> denna artikel till andra?",
	...
	"RATE_IT_MSG" => "Betygsätt den",
	"NAME_ALIAS_MSG" => "Namn eller alias",
	...
	"ALLOWED_VIEW_REVIEWS_MSG" => "Tillåts att se recensioner",
	"ALLOWED_POST_REVIEWS_MSG" => "Tillåts att posta recensioner",
	"ALLOWED_LIKE_MSG" => "Allowed to Like",
	"ALLOWED_DISLIKE_MSG" => "Allowed to Disike",
	"REVIEWS_PER_PRODUCT_MSG" => "Antal recensioner per kund",
	"REVIEWS_PER_PRODUCT_DESC" => "Lämna detta fält tomt om du inte vill begränsa antalet recensioner som varje kund kan lämna",
	"REVIEWS_PER_ARTICLE_MSG" => "Antal recensioner per kund",
	"REVIEWS_PER_ARTICLE_DESC" => "Lämna detta fält tomt om du inte vill begränsa antalet recensioner som varje kund kan lämna",
	"REVIEWS_PERIOD_MSG" => "Recensionsperiod",
	...
	"COMMENTS_PER_REVIEW_MSG" => "Antal recensioner per kund",
	"COMMENTS_PER_REVIEW_DESC" => "Lämna detta fält tomt om du inte vill begränsa antalet recensioner som varje kund kan lämna",
	"COMMENTS_PERIOD_MSG" => "Recensionsperiod",
	...
	"NO_QUESTIONS_MSG" => "Inga frågor hittades",
	...
	"QUESTION_SAVED_FOR_APPROVAL_MSG" => "Tack så mycket!<br>Din kommentar kommer granskas. Om den godkänns kommer den snart synas på webbplatsen. <br>Vi reserverar rätten att neka insändare som inte möter våra riktlinjer.",
	"ALREADY_ASKED_MSG" => "Du har redan skrivit en recension.",
