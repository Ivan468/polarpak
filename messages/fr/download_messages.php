...
$messages = array(
	// download messages
	"DOWNLOAD_WRONG_PARAM" => "Parameter(s) faux de téléchargement.",
	"DOWNLOAD_MISS_PARAM" => "Parameter(s) absent de téléchargement.",
	"DOWNLOAD_INACTIVE" => "Téléchargement inactif.",
	"DOWNLOAD_EXPIRED" => "Votre période de téléchargement a été expirée.",
	"DOWNLOAD_LIMITED" => "Vous excédez le nombre maximum des téléchargements.",
	"DOWNLOAD_PATH_ERROR" => "Le chemin au produit ne peut pas être trouvé.",
	"DOWNLOAD_RELEASE_ERROR" => "Libérez n'a pas été trouvé.",
	"DOWNLOAD_USER_ERROR" => "Seulement les utilisateurs enregistrés peuvent télécharger ce dossier.",
	...
	"UPLOAD_SELECT_MSG" => "Choisissez le dossier à télécharger et appuyer sur le {button_name} bouton",
	"SPECIFY_PATH_FILE_MSG" => "Or please specify the path to your file and press 'Continue' button.",
	"UPLOADED_FILE_MSG" => "Le dossier b a été bien téléchargé",
	"UPLOAD_SELECT_ERROR" => "Veuillez d'abord selectionner le dossier",
	"UPLOAD_IMAGE_ERROR" => "Uniquement les dossiers contenant les images sont autorisés",
	"UPLOAD_FORMAT_ERROR" => "This type of file is not allowed.",
	"UPLOAD_SIZE_ERROR" => "Les dossiers qui depassent la taille {filesize} ne sont pas autorisés",
	"UPLOAD_DIMENSION_ERROR" => "Les images qui depassent {dimension} ne sont pas autorisés",
	"UPLOAD_CREATE_ERROR" => "Le système n'a pas pu céer le dossier",
