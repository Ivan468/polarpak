...
$messages = array(
	...
	"AVERAGE_MSG" => "Average",
	"GOOD_MSG" => "Good",
	"EXCELLENT_MSG" => "Excellent",
	"REVIEWS_MSG" => "Reviews",
	"NO_REVIEWS_MSG" => "No reviews found",
	"WRITE_REVIEW_MSG" => "Write a review",
	"WRITE_REVIEW_SIGN_IN_MSG" => "Sign in to write a review",
	"RATE_PRODUCT_MSG" => "Rate this product",
	"RATE_ARTICLE_MSG" => "Rate this article",
	"NOT_RATED_PRODUCT_MSG" => "Le produit non évalué encore.",
	"NOT_RATED_ARTICLE_MSG" => "Article isn't rated yet.",
	"AVERAGE_RATING_MSG" => "Average Rating",
	"BASED_ON_REVIEWS_MSG" => "based on {total_votes} reviews.",
	"SEE_ALL_REVIEWS_MSG" => "See all customer reviews.",
	"ALL_REVIEWS_MSG" => "All Reviews",
	"ONLY_POSITIVE_MSG" => "Only Positive",
	"ONLY_NEGATIVE_MSG" => "Only Negative",
	"POSITIVE_REVIEWS_MSG" => "Positive Reviews",
	"NEGATIVE_REVIEWS_MSG" => "Negative Reviews",
	"NEUTRAL_REVIEWS_MSG" => "Neutral Reviews",
	"REVIEW_SAVED_MSG" => "Thank you, your review has been saved.",
	"REVIEW_SAVED_FOR_APPROVAL_MSG" => "Thank you, your review was saved and If approved it will appear on our site.<br>We reserve the right to decline any submissions that don't meet our guidelines.",
	"ALREADY_REVIEWED_MSG" => "You have already placed a review.",
	...
	"NO_QUESTIONS_MSG" => "Aucune question ne correspond à votre requête",
	...
	"QUESTION_SAVED_FOR_APPROVAL_MSG" => "Thank you, your question was saved and If approved it will appear on our site.",
	"ALREADY_ASKED_MSG" => "You have already asked a question.",
