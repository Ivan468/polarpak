...
$messages = array(
	...
	"OPTIONAL_MSG" => "Alternatywny",
	"RATING_MSG" => "Rating",
	"BAD_MSG" => "Zły",
	"POOR_MSG" => "Słąby",
	"AVERAGE_MSG" => "Przeciętny",
	"GOOD_MSG" => "Dobry",
	"EXCELLENT_MSG" => "Doskonały",
	"REVIEWS_MSG" => "Recenzje",
	"NO_REVIEWS_MSG" => "Nie znaleziono recenzji",
	"WRITE_REVIEW_MSG" => "Napisz recenzję",
	"WRITE_REVIEW_SIGN_IN_MSG" => "Sign in to write a review",
	"RATE_PRODUCT_MSG" => "Oceń ten produkt",
	"RATE_ARTICLE_MSG" => "Oceń ten artykuł",
	"NOT_RATED_PRODUCT_MSG" => "Produkt nie dostał jeszcze oceny",
	"NOT_RATED_ARTICLE_MSG" => "Artykuł nie dostał jeszcze oceny",
	"AVERAGE_RATING_MSG" => "Statystyczne oceny",
	"BASED_ON_REVIEWS_MSG" => "bazujący na {total_votes} recenzjach",
	"SEE_ALL_REVIEWS_MSG" => "Zobacz wszystkie recenzje klientów",
	"ALL_REVIEWS_MSG" => "Wszystkie recenzje",
	"ONLY_POSITIVE_MSG" => "Tylko pozytywne",
	"ONLY_NEGATIVE_MSG" => "Tylko negatywne",
	"POSITIVE_REVIEWS_MSG" => "Pozytywne recenzje",
	"NEGATIVE_REVIEWS_MSG" => "Negatywne recenzje",
	"NEUTRAL_REVIEWS_MSG" => "Neutral Reviews",
	"REVIEW_SAVED_MSG" => "Thank you, your review has been saved.",
	"REVIEW_SAVED_FOR_APPROVAL_MSG" => "Dziękujemy<br>Twoje komentarze zostały dodane. Jeśli je zaakceptujemy pojawią się na stronie.<br> Zastrzegamy sobie prawo do odrzucenia jakichkolwiek wpisów niezgodnych z naszymi celami.",
	"ALREADY_REVIEWED_MSG" => "Już umieściłeś recenzję",
	"ALREADY_REVIEWED_PRODUCT_MSG" => "You have already placed a review for this product.",
	"RECOMMEND_PRODUCT_MSG" => "Czy chcesz zarekomendować<br>ten produkt swoim znajomym?",
	"RECOMMEND_ARTICLE_MSG" => "Czy chcesz zarekomendować<br>ten artykuł swoim znajomym?",
	...
	"RATE_IT_MSG" => "Oceń to",
	"NAME_ALIAS_MSG" => "Nazwa lub alias",
	"YOUR_COMMENTS_MSG" => "Your comments",
	"SHOW_MSG" => "Pokaż",
	"FOUND_MSG" => "Znaleziono",
	...
	"NO_QUESTIONS_MSG" => "Nie znaleziono pytań",
	...
	"QUESTION_SAVED_FOR_APPROVAL_MSG" => "Dziękujemy<br>Twoje komentarze zostały dodane. Jeśli je zaakceptujemy pojawią się na stronie.<br> Zastrzegamy sobie prawo do odrzucenia jakichkolwiek wpisów niezgodnych z naszymi celami.",
	"ALREADY_ASKED_MSG" => "Już umieściłeś recenzję",
