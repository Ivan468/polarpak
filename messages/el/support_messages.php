...
$messages = array(
	// support messages
	"SUPPORT_TITLE" => "Κέντρο βοήθειας",
	"SUPPORT_REQUEST_INF_TITLE" => "Πληροφορίες ερωτήματος",
	"SUPPORT_REPLY_FORM_TITLE" => "Απάντηση",
	"SUPPORT_SHORT_TITLE" => "Support",

	"MY_SUPPORT_ISSUES_MSG" => "Τα αιτήματα μου για Βοήθεια",
	"MY_SUPPORT_ISSUES_DESC" => "Εάν Έχετε οποιοδήποτε πρόβλημα με προϊόν που Έχετε αγοράσει οι υπεύθυνοι για την Βοήθεια είναι έτοιμοι να το λύσουν . Επικοινωνήστε μαζί μας κάνοντας κλικ πιο κάτω και γράψτε το πρόβλημα σας",
	"NEW_SUPPORT_REQUEST_MSG" => "Νέο αίτημα βοήθειας",
	"SUPPORT_REQUEST_ADDED_MSG" => "ευχαριστούμε , το προσωπικό για την Βοήθεια θα προσπαθήσει να σας βοηθήσει πολύ σύντομα",
	"SUPPORT_SELECT_DEP_MSG" => "επιλέξτε τμήμα",
	"SUPPORT_SELECT_PROD_MSG" => "επιλέξτε προϊόν",
	"SUPPORT_SELECT_STATUS_MSG" => "επιλέξτε Κατάσταση",
	"SUPPORT_NOT_VIEWED_MSG" => "Δεν το είδαν ακόμη",
	"SUPPORT_VIEWED_BY_USER_MSG" => "Το έχουν δει επισκέπτες",
	"SUPPORT_VIEWED_BY_ADMIN_MSG" => "Το Έχει δει ο διαχειριστής",
	"SUPPORT_STATUS_NEW_MSG" => "Νέο",
	"NO_SUPPORT_REQUEST_MSG" => "Κανένα ζήτημα δεν βρέθηκε",

	"SUPPORT_SUMMARY_COLUMN" => "Περίληψη",
	"SUPPORT_TYPE_COLUMN" => "Τύπος",
	"SUPPORT_UPDATED_COLUMN" => "Τελευταία ανανέωση",

	"SUPPORT_USER_NAME_FIELD" => "Το Όνομα σας",
	"SUPPORT_USER_EMAIL_FIELD" => "Το e-mail σας",
	"SUPPORT_IDENTIFIER_FIELD" => "Παραστατικό (τιμολόγιο #)",
	"SUPPORT_ENVIRONMENT_FIELD" => "Περιβάλλον (OS, Database, Web Server, etc.)",
	"SUPPORT_DEPARTMENT_FIELD" => "τμήμα",
	"SUPPORT_PRODUCT_FIELD" => "προϊόν",
	"SUPPORT_TYPE_FIELD" => "Τύπος",
	"SUPPORT_CURRENT_STATUS_FIELD" => "Υπάρχουσα Κατάσταση",
	"SUPPORT_SUMMARY_FIELD" => "Περίληψη",
	"SUPPORT_DESCRIPTION_FIELD" => "Περιγραφή",
	"SUPPORT_MESSAGE_FIELD" => "Μήνυμα",
	"SUPPORT_ADDED_FIELD" => "Προστέθηκε",
	"SUPPORT_ADDED_BY_FIELD" => "Προστέθηκε από",
	"SUPPORT_UPDATED_FIELD" => "Τελευταία ανανέωση",

	"SUPPORT_REQUEST_BUTTON" => "Submit Request",
	                                    
	"SUPPORT_MISS_ID_ERROR" => "Λείπει το <b> ID βοήθειας</b>",
	"SUPPORT_MISS_CODE_ERROR" => "Λείπει η παράμετρος <b>επιβεβαίωσης</b>",
	"SUPPORT_WRONG_ID_ERROR" => "<b>Το ID βοήθειας</b> Έχει λανθασμένες παραμέτρους",
	"SUPPORT_WRONG_CODE_ERROR" => "<b>Η επιβεβαίωση </b> Έχει Λάθος παραμέτρους",
