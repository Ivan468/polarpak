...
$messages = array(
	// support messages
	"SUPPORT_TITLE" => "Destek Merkezi",
	"SUPPORT_REQUEST_INF_TITLE" => "Destek Talep Bilgiler",
	"SUPPORT_REPLY_FORM_TITLE" => "Yanıtla",
	"SUPPORT_SHORT_TITLE" => "Support",

	"MY_SUPPORT_ISSUES_MSG" => "Destek Taleplerim",
	"MY_SUPPORT_ISSUES_DESC" => "Sitemizden satın aldığınız ürünlerle ilgili olarak yaşadığınız problemler için destek ekibimiz hizmetinizdedir.. Lütfen yukarıdaki linke tıklayarak problemi bildiriniz.",
	"NEW_SUPPORT_REQUEST_MSG" => "Yeni Talep",
	"SUPPORT_REQUEST_ADDED_MSG" => "Teşekkür ederiz<br>Talebiniz en kısa zamanda gerçekleştirilecektir.",
	"SUPPORT_SELECT_DEP_MSG" => "Bölüm Seçiniz",
	"SUPPORT_SELECT_PROD_MSG" => "Ürün Seçiniz",
	"SUPPORT_SELECT_STATUS_MSG" => "Durum Seçiniz",
	"SUPPORT_NOT_VIEWED_MSG" => "İzlenmedi",
	"SUPPORT_VIEWED_BY_USER_MSG" => "Müşteri Okudu.",
	"SUPPORT_VIEWED_BY_ADMIN_MSG" => "Admin Okudu.",
	"SUPPORT_STATUS_NEW_MSG" => "Yeni  ",
	"NO_SUPPORT_REQUEST_MSG" => "Bulunamadı",

	"SUPPORT_SUMMARY_COLUMN" => "Özet",
	"SUPPORT_TYPE_COLUMN" => "Tip",
	"SUPPORT_UPDATED_COLUMN" => "Son Güncelleme",

	"SUPPORT_USER_NAME_FIELD" => "Adınız",
	"SUPPORT_USER_EMAIL_FIELD" => "Eposta Adresiniz",
	"SUPPORT_IDENTIFIER_FIELD" => "Kimlik (Fatura #)",
	"SUPPORT_ENVIRONMENT_FIELD" => "Ürün Modeli (Örn. Motorola L6)",
	"SUPPORT_DEPARTMENT_FIELD" => "Bölüm",
	"SUPPORT_PRODUCT_FIELD" => "Ürün",
	"SUPPORT_TYPE_FIELD" => "Tip",
	"SUPPORT_CURRENT_STATUS_FIELD" => "Cari Durum",
	"SUPPORT_SUMMARY_FIELD" => "Tek satırlık Özet",
	"SUPPORT_DESCRIPTION_FIELD" => "Tanım",
	"SUPPORT_MESSAGE_FIELD" => "Mesaj",
	"SUPPORT_ADDED_FIELD" => "Eklendi",
	"SUPPORT_ADDED_BY_FIELD" => "Ekleyen",
	"SUPPORT_UPDATED_FIELD" => "Son Güncelleştirme",

	"SUPPORT_REQUEST_BUTTON" => "Talebi Gönder",
	                                    
	"SUPPORT_MISS_ID_ERROR" => "<b>Destek ID</b> bilgisi eksik.",
	"SUPPORT_MISS_CODE_ERROR" => "<b>Onay</b> bilgisi eksik.",
	"SUPPORT_WRONG_ID_ERROR" => "<b>Destek ID</b> bilgisi yanlış.",
	"SUPPORT_WRONG_CODE_ERROR" => "<b>Onay</b> bilgisi yanlış.",

	"MAIL_DATA_MSG" => "posta verisi/bilgisi",
	"HEADERS_MSG" => "sayfa başlığı",
	"ORIGINAL_TEXT_MSG" => "orijinal metin",
	"ORIGINAL_HTML_MSG" => "orijinal HTML",
