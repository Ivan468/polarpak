...
$messages = array(
	// comentarios/mensajes de evaluación
	"OPTIONAL_MSG" => "Opcional",
	"RATING_MSG" => "Evaluación",
	"BAD_MSG" => "Malo",
	"POOR_MSG" => "Mediocre",
	"AVERAGE_MSG" => "Normal",
	"GOOD_MSG" => "Bueno",
	"EXCELLENT_MSG" => "Excelente",
	"REVIEWS_MSG" => "Críticas",
	"NO_REVIEWS_MSG" => "No hay comentarios en la base de datos",
	"WRITE_REVIEW_MSG" => "Escribir un comentario",
	"WRITE_REVIEW_SIGN_IN_MSG" => "Sign in to write a review",
	"RATE_PRODUCT_MSG" => "Valorar el producto",
	"RATE_ARTICLE_MSG" => "Valorar el artículo",
	"NOT_RATED_PRODUCT_MSG" => "El producto no ha sido valorado",
	"NOT_RATED_ARTICLE_MSG" => "El artículo no ha sido valorado",
	"AVERAGE_RATING_MSG" => "Valoración media",
	"BASED_ON_REVIEWS_MSG" => "basado en {total_votes} comentarios",
	"SEE_ALL_REVIEWS_MSG" => "Ver todos los comentarios de los clientes",
	"ALL_REVIEWS_MSG" => "Todos los comentarios",
	"ONLY_POSITIVE_MSG" => "Solamente positivos",
	"ONLY_NEGATIVE_MSG" => "Solamente negativos",
	"POSITIVE_REVIEWS_MSG" => "Comentarios positivos",
	"NEGATIVE_REVIEWS_MSG" => "Comentarios negativos",
	"NEUTRAL_REVIEWS_MSG" => "Neutral Reviews",
	"REVIEW_SAVED_MSG" => "Thank you, your review has been saved.",
	"REVIEW_SAVED_FOR_APPROVAL_MSG" => "Gracias <br> Sus comentarios se revisarán y si se aprueban, aparecerán en nuestro sitio. <br>Nos reservamos el derecho de declinar cualquier comentario que no concuerde con los principios de nuestra empresa.",
	"ALREADY_REVIEWED_MSG" => "Ya ha puesto su comentario",
	"ALREADY_REVIEWED_PRODUCT_MSG" => "You have already placed a review for this product.",
	"RECOMMEND_PRODUCT_MSG" => "¿Recomendaría usted<br>este producto a otras personas?",
	"RECOMMEND_ARTICLE_MSG" => "¿Recomendaría usted<br>este artículo a otras personas?",
	...
	"RATE_IT_MSG" => "Valore este producto",
	"NAME_ALIAS_MSG" => "Nombre o apodo",
	"YOUR_COMMENTS_MSG" => "Your comments",
	"SHOW_MSG" => "Mostrar",
	"FOUND_MSG" => "Encontrado",
	...
	"NO_QUESTIONS_MSG" => "No hay preguntas en la base de datos",
	...
	"QUESTION_SAVED_FOR_APPROVAL_MSG" => "Gracias <br> Sus comentarios se revisarán y si se aprueban, aparecerán en nuestro sitio. <br>Nos reservamos el derecho de declinar cualquier comentario que no concuerde con los principios de nuestra empresa.",
	"ALREADY_ASKED_MSG" => "Ya ha puesto su comentario",
