...
$messages = array(
	...
	"SUPPORT_REQUEST_INF_TITLE" => "Pedir información",
	"SUPPORT_REPLY_FORM_TITLE" => "Responder",
	"SUPPORT_SHORT_TITLE" => "Support",

	"MY_SUPPORT_ISSUES_MSG" => "Mis peticiones de ayuda",
	"MY_SUPPORT_ISSUES_DESC" => "Si tiene algún problema con el producto que ha comprado, nuestros administradores estarán dispuestos a resolverlo. Siéntase libre de contactarnos pinchando el enlace de arriba y escribiendo su petición de ayuda. ",
	"NEW_SUPPORT_REQUEST_MSG" => "Nueva petición",
	"SUPPORT_REQUEST_ADDED_MSG" => "Gracias<br>Nuestro aquipo de ayuda tratará de atender su petición lo más pronto posible.",
	"SUPPORT_SELECT_DEP_MSG" => "Seleccionar departamento",
	"SUPPORT_SELECT_PROD_MSG" => "Seleccionar producto",
	"SUPPORT_SELECT_STATUS_MSG" => "Seleccionar estado",
	"SUPPORT_NOT_VIEWED_MSG" => "No visto",
	"SUPPORT_VIEWED_BY_USER_MSG" => "Visto por el cliente",
	"SUPPORT_VIEWED_BY_ADMIN_MSG" => "Visto por el administrador",
	"SUPPORT_STATUS_NEW_MSG" => "Nuevo",
	"NO_SUPPORT_REQUEST_MSG" => "No se encontraron peticiones",

	"SUPPORT_SUMMARY_COLUMN" => "Resumen",
	"SUPPORT_TYPE_COLUMN" => "Tipo",
	"SUPPORT_UPDATED_COLUMN" => "Última Actualización ",

	"SUPPORT_USER_NAME_FIELD" => "Su nombre",
	"SUPPORT_USER_EMAIL_FIELD" => "Su correo electrónico",
	"SUPPORT_IDENTIFIER_FIELD" => "Identificación (Factura #)",
	"SUPPORT_ENVIRONMENT_FIELD" => "Entorno (Sistema Operativo, Base de datos, Servidor de Web, ets.)",
	"SUPPORT_DEPARTMENT_FIELD" => "Departamento",
	"SUPPORT_PRODUCT_FIELD" => "Producto",
	"SUPPORT_TYPE_FIELD" => "Tipo",
	"SUPPORT_CURRENT_STATUS_FIELD" => "Condición Actual",
	"SUPPORT_SUMMARY_FIELD" => "Resumen en-linea",
	"SUPPORT_DESCRIPTION_FIELD" => "Descripción",
	"SUPPORT_MESSAGE_FIELD" => "Mensaje",
	"SUPPORT_ADDED_FIELD" => "Añadido",
	"SUPPORT_ADDED_BY_FIELD" => "Añadido por",
	"SUPPORT_UPDATED_FIELD" => "Última actualización",

	"SUPPORT_REQUEST_BUTTON" => "Enviar Petición",
	                                    
	"SUPPORT_MISS_ID_ERROR" => "Falta el parametro de <b>Identificador de ayuda</b>",
	"SUPPORT_MISS_CODE_ERROR" => "Falta el paramento de <b> verificación</b>",
	"SUPPORT_WRONG_ID_ERROR" => "El parametro de <b>Identificador de ayuda</b> tiene un valor erróneo",
	"SUPPORT_WRONG_CODE_ERROR" => "El parametro de <b>verificación</b> tiene un valor erróneo",

	"MAIL_DATA_MSG" => "Datos de Email",
	"HEADERS_MSG" => "Cabeceras",
