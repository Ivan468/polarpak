...
$messages = array(
	...
	"BAD_MSG" => "1 ster",
	"POOR_MSG" => "2 sterren",
	"AVERAGE_MSG" => "3 sterren",
	"GOOD_MSG" => "4 sterren",
	"EXCELLENT_MSG" => "5 sterren",
	"REVIEWS_MSG" => "Reviews",
	"NO_REVIEWS_MSG" => "Geen reviews gevonden",
	"WRITE_REVIEW_MSG" => "Geef uw mening",
	"WRITE_REVIEW_SIGN_IN_MSG" => "Sign in to write a review",
	"RATE_PRODUCT_MSG" => "Beoordeel dit product",
	"RATE_ARTICLE_MSG" => "<font size=\"3\"><b>Reageer!</b></font>",
	"NOT_RATED_PRODUCT_MSG" => "Product nog niet beoordeeld.",
	"NOT_RATED_ARTICLE_MSG" => "Er zijn nog geen reacties op dit artikel.",
	"AVERAGE_RATING_MSG" => "Gemiddelde beoordeling",
	"BASED_ON_REVIEWS_MSG" => "gebaseerd op {total_votes} beoordelingen",
	"SEE_ALL_REVIEWS_MSG" => "Bekijk alle beoordelingen...",
	"ALL_REVIEWS_MSG" => "Alle beoordelingen",
	"ONLY_POSITIVE_MSG" => "Alleen positieve",
	"ONLY_NEGATIVE_MSG" => "Alleen negatieve",
	"POSITIVE_REVIEWS_MSG" => "Positieve beoordelingen",
	"NEGATIVE_REVIEWS_MSG" => "Negatieve beoordelingen",
	"NEUTRAL_REVIEWS_MSG" => "Neutral Reviews",
	"REVIEW_SAVED_MSG" => "Thank you, your review has been saved.",
	"REVIEW_SAVED_FOR_APPROVAL_MSG" => "Bedankt.<br>Uw opmerkingen zullen worden beoordeeld en, indien goedgekeurd, op onze website worden geplaatst.<br>We behouden ons het recht voor om reviews te weigeren.",
	"ALREADY_REVIEWED_MSG" => "U heeft al een review geplaatst.",
	"ALREADY_REVIEWED_PRODUCT_MSG" => "You have already placed a review for this product.",
	"RECOMMEND_PRODUCT_MSG" => "Zou u dit product<br> aan anderen aanbevelen?",
	"RECOMMEND_ARTICLE_MSG" => "Zou u dit artikel <br> aan anderen aanbevelen?",
	...
	"RATE_IT_MSG" => "Beoordeling",
	"NAME_ALIAS_MSG" => "Uw naam",
	...
	"NO_QUESTIONS_MSG" => "Geen vragen gevonden",
	...
	"QUESTION_SAVED_FOR_APPROVAL_MSG" => "Bedankt.<br>Uw opmerkingen zullen worden beoordeeld en, indien goedgekeurd, op onze website worden geplaatst.<br>We behouden ons het recht voor om reviews te weigeren.",
	"ALREADY_ASKED_MSG" => "U heeft al een review geplaatst.",
