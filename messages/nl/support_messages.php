...
$messages = array(
	// support messages
	"SUPPORT_TITLE" => "Helpdesk",
	"SUPPORT_REQUEST_INF_TITLE" => "Verzoek om Informatie",
	"SUPPORT_REPLY_FORM_TITLE" => "Antwoord",
	"SUPPORT_SHORT_TITLE" => "Support",

	"MY_SUPPORT_ISSUES_MSG" => "Mijn support aanvragen",
	"MY_SUPPORT_ISSUES_DESC" => "Als u een probleem heeft met een bij ons gekocht product staan onze support managers voor u klaar. Neem aub contact met ons op door op de link hierboven te klikken en Support aan te vragen.",
	"NEW_SUPPORT_REQUEST_MSG" => "Nieuwe aanvraag",
	"SUPPORT_REQUEST_ADDED_MSG" => "Bedankt.<br>Ons support team zal u zo snel als mogelijk proberen te helpen.",
	"SUPPORT_SELECT_DEP_MSG" => "Selecteer afdeling",
	"SUPPORT_SELECT_PROD_MSG" => "Selecteer type",
	"SUPPORT_SELECT_STATUS_MSG" => "Selecteer status",
	"SUPPORT_NOT_VIEWED_MSG" => "Niet bekeken",
	"SUPPORT_VIEWED_BY_USER_MSG" => "Bekeken door klant",
	"SUPPORT_VIEWED_BY_ADMIN_MSG" => "Bekeken door beheerder",
	"SUPPORT_STATUS_NEW_MSG" => "Nieuw",
	"NO_SUPPORT_REQUEST_MSG" => "Geen onderwerpen gevonden",

	"SUPPORT_SUMMARY_COLUMN" => "Samenvatting",
	"SUPPORT_TYPE_COLUMN" => "Type",
	"SUPPORT_UPDATED_COLUMN" => "Laatst Bijgewerkt",

	"SUPPORT_USER_NAME_FIELD" => "Uw naam",
	"SUPPORT_USER_EMAIL_FIELD" => "Uw email adres",
	"SUPPORT_IDENTIFIER_FIELD" => "Uniek nummer(Faktuur #)",
	"SUPPORT_ENVIRONMENT_FIELD" => "Omgeving (OS, Database, Web Server, etc.)",
	"SUPPORT_DEPARTMENT_FIELD" => "Afdeling",
	"SUPPORT_PRODUCT_FIELD" => "Product",
	"SUPPORT_TYPE_FIELD" => "Type",
	"SUPPORT_CURRENT_STATUS_FIELD" => "Huidige status",
	"SUPPORT_SUMMARY_FIELD" => "Samenvatting",
	"SUPPORT_DESCRIPTION_FIELD" => "Beschrijving",
	"SUPPORT_MESSAGE_FIELD" => "Bericht",
	"SUPPORT_ADDED_FIELD" => "Toegevoegd",
	"SUPPORT_ADDED_BY_FIELD" => "Toegevoegd door",
	"SUPPORT_UPDATED_FIELD" => "Laatst bijgewerkt",

	"SUPPORT_REQUEST_BUTTON" => "Verstuur aanvraag",
	                                    
	"SUPPORT_MISS_ID_ERROR" => "Ontbrekende <b>Support ID</b> parameter",
	"SUPPORT_MISS_CODE_ERROR" => "Ontbrekende <b>Verification</b> parameter",
	"SUPPORT_WRONG_ID_ERROR" => "<b>Support ID</b> parameter heeft onjuiste waarde",
	"SUPPORT_WRONG_CODE_ERROR" => "<b>Verification</b> parameter heeft onjuiste waarde",

	"MAIL_DATA_MSG" => "Email data",
	"HEADERS_MSG" => "Titel",
	"ORIGINAL_TEXT_MSG" => "Orginele tekst",
	"ORIGINAL_HTML_MSG" => "Orginele HTML",
	...
	"NO_TICKETS_FOUND_MSG" => "Géén aanvragen gevonden",
	"HIDDEN_TICKETS_MSG" => "Verborgen aanvragen",
	"ALL_TICKETS_MSG" => "Alle aanvragen",
	"ACTIVE_TICKETS_MSG" => "Active aanvragen",
	...
	"REPLY_TO_NAME_MSG" => "Antwoord aan {name}",
	"KNOWLEDGE_CATEGORY_MSG" => "Kennis gategorie",
	"KNOWLEDGE_TITLE_MSG" => "De Titel van de kennis",
	"KNOWLEDGE_ARTICLE_STATUS_MSG" => "De Status Artikel kennis",
	"SELECT_RESPONSIBLE_MSG" => "Selecteer verantwoordelijke",
	//ticket types
