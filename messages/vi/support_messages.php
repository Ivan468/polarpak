...
$messages = array(
	// support messages
	"SUPPORT_TITLE" => "Trung tâm hỗ trợ",
	"SUPPORT_REQUEST_INF_TITLE" => "Thông tin yêu cầu",
	"SUPPORT_REPLY_FORM_TITLE" => "Phản hồi",
	"SUPPORT_SHORT_TITLE" => "Support",

	"MY_SUPPORT_ISSUES_MSG" => "Yêu cầu hỗ trợ của tôi",
	"MY_SUPPORT_ISSUES_DESC" => "Nếu bạn gặp vài vấn đề với những sản phẩm mà bạn đã mua, bộ phận hỗ trợ của chúng tôi sẳn sàng giúp đỡ.",
	"NEW_SUPPORT_REQUEST_MSG" => "Yêu cầu mới",
	"SUPPORT_REQUEST_ADDED_MSG" => "Cám ơn bạn<br>Bộ phận hỗ trợ của chúng tôi sẽ cố gắng phục vụ yêu cầu của bạn nhanh nhất có thể.",
	"SUPPORT_SELECT_DEP_MSG" => "Lựa chọn Bộ phận.",
	"SUPPORT_SELECT_PROD_MSG" => "Lựa chọn sản phẩm",
	"SUPPORT_SELECT_STATUS_MSG" => "Lựa chọn tình trạng",
	"SUPPORT_NOT_VIEWED_MSG" => "Không xem",
	"SUPPORT_VIEWED_BY_USER_MSG" => "Xem bởi người dùng",
	"SUPPORT_VIEWED_BY_ADMIN_MSG" => "Xem bởi người quản trị",
	"SUPPORT_STATUS_NEW_MSG" => "Mới",
	"NO_SUPPORT_REQUEST_MSG" => "Không tìm thấy",

	"SUPPORT_SUMMARY_COLUMN" => "Tóm tắt",
	"SUPPORT_TYPE_COLUMN" => "Loại",
	"SUPPORT_UPDATED_COLUMN" => "Lần cập nhật cuối",

	"SUPPORT_USER_NAME_FIELD" => "Tên",
	"SUPPORT_USER_EMAIL_FIELD" => "Địa chỉ email của bạn",
	"SUPPORT_IDENTIFIER_FIELD" => "Mã số hóa đơn",
	"SUPPORT_ENVIRONMENT_FIELD" => "Các mô tả (Hệ điều hành, database, máy chủ web, etc.)",
	"SUPPORT_DEPARTMENT_FIELD" => "Bộ phận",
	"SUPPORT_PRODUCT_FIELD" => "Sản phẩm",
	"SUPPORT_TYPE_FIELD" => "Loại",
	"SUPPORT_CURRENT_STATUS_FIELD" => "Tình trạng hiện tại",
	"SUPPORT_SUMMARY_FIELD" => "Tóm tắt ngắn gọn",
	"SUPPORT_DESCRIPTION_FIELD" => "Mô tả",
	"SUPPORT_MESSAGE_FIELD" => "Nội dung",
	"SUPPORT_ADDED_FIELD" => "Thêm",
	"SUPPORT_ADDED_BY_FIELD" => "Thêm bởi",
	"SUPPORT_UPDATED_FIELD" => "Lần cập nhật cuối",

	"SUPPORT_REQUEST_BUTTON" => "Đưa yêu cầu",
	                                    
	"SUPPORT_MISS_ID_ERROR" => "Sai tham số<b>số ID hỗ trợ</b>",
	"SUPPORT_MISS_CODE_ERROR" => "Sai tham số <b>Xác thực</b>",
	"SUPPORT_WRONG_ID_ERROR" => "<b>mã số ID hỗ trợ</b> bị sai giá trị",
	"SUPPORT_WRONG_CODE_ERROR" => "<b>Xác thực</b> tham số bị sai",

	"MAIL_DATA_MSG" => "Dữ liệu mail",
	"HEADERS_MSG" => "Tiêu đề",
	"ORIGINAL_TEXT_MSG" => "Nội dung (text)",
	"ORIGINAL_HTML_MSG" => "Nội dung (HTML)",
