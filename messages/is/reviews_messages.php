...
$messages = array(
	...
	"OPTIONAL_MSG" => "Valfrjáls",
	"RATING_MSG" => "Rating",
	"BAD_MSG" => "Mjög léleg",
	"POOR_MSG" => "Frekar léleg",
	"AVERAGE_MSG" => "Hvorki né",
	"GOOD_MSG" => "Frekar góð",
	"EXCELLENT_MSG" => "Mjög góð",
	"REVIEWS_MSG" => "Álit",
	"NO_REVIEWS_MSG" => "Engin álit fundust",
	"WRITE_REVIEW_MSG" => "Skrifa álit",
	"WRITE_REVIEW_SIGN_IN_MSG" => "Sign in to write a review",
	"RATE_PRODUCT_MSG" => "Gefa þessari vöru einkunn",
	"RATE_ARTICLE_MSG" => "Gefa þessari grein einkunn",
	"NOT_RATED_PRODUCT_MSG" => "Vöru hefur ekki verið gefin einkunn",
	"NOT_RATED_ARTICLE_MSG" => "Grein hefur ekki verið gefin einkunn",
	"AVERAGE_RATING_MSG" => "Meðaleinkunn",
	"BASED_ON_REVIEWS_MSG" => "reiknað út frá {total_votes} álitum",
	"SEE_ALL_REVIEWS_MSG" => "Sjá öll álit viðskiptavina..",
	"ALL_REVIEWS_MSG" => "Öll álit",
	"ONLY_POSITIVE_MSG" => "Aðeins jákvæð",
	"ONLY_NEGATIVE_MSG" => "Aðeins neikvæð",
	"POSITIVE_REVIEWS_MSG" => "Jákvæð álit",
	"NEGATIVE_REVIEWS_MSG" => "Neikvæð álit",
	"NEUTRAL_REVIEWS_MSG" => "Neutral Reviews",
	"REVIEW_SAVED_MSG" => "Thank you, your review has been saved.",
	"REVIEW_SAVED_FOR_APPROVAL_MSG" => "Takk fyrir. <br> Athugasemdir þínar verða skoðaðar. Verði þær samþykktar munu þær birtast á síðunni okkar.<br> Við áskiljum okkur þann rétt að hafna greinum stangist þær á við leiðarvísi okkar. ",
	"ALREADY_REVIEWED_MSG" => "Þú hefur nú þegar sent inn álit",
	"ALREADY_REVIEWED_PRODUCT_MSG" => "You have already placed a review for this product.",
	"RECOMMEND_PRODUCT_MSG" => "Myndir þú mæla með<br> þessari vöru við aðra?",
	"RECOMMEND_ARTICLE_MSG" => "Myndir þú mæla með<br> þessari grein við aðra? ",
	...
	"RATE_IT_MSG" => "Gefa því einkunn",
	"NAME_ALIAS_MSG" => "Nafn eða gælunafn",
	...
	"NO_QUESTIONS_MSG" => "Engar spurningar fundust",
	...
	"QUESTION_SAVED_FOR_APPROVAL_MSG" => "Takk fyrir. <br> Athugasemdir þínar verða skoðaðar. Verði þær samþykktar munu þær birtast á síðunni okkar.<br> Við áskiljum okkur þann rétt að hafna greinum stangist þær á við leiðarvísi okkar. ",
	"ALREADY_ASKED_MSG" => "Þú hefur nú þegar sent inn álit",
