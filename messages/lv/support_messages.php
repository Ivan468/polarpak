...
$messages = array(
	// support messages
	"SUPPORT_TITLE" => "Atbalsta centrs",
	"SUPPORT_REQUEST_INF_TITLE" => "Atbalsta informācija",
	"SUPPORT_REPLY_FORM_TITLE" => "Atbilde",
	"SUPPORT_SHORT_TITLE" => "Support",

	"MY_SUPPORT_ISSUES_MSG" => "Mani atbalsta pieprasījumi",
	"MY_SUPPORT_ISSUES_DESC" => "Ja Jums ir radušās problēmas ar kādu no mūsu produktiem/pakalpojumiem, lūdzu, jautājiet mūsu Klientu atbalsta komandai. Spiediet uz zemāka redzamās saites, lai nosūtītu savu pieprasījumu mūsu Klientu atbalsta speciālistiem.",
	"NEW_SUPPORT_REQUEST_MSG" => "Jauns pieprasījums",
	"SUPPORT_REQUEST_ADDED_MSG" => "Paldies!<br>Klienta atbalsta speciālisti ar Jums sazināsies tuvākajā laikā, lai sniegtu Jums nepieciešamo atbalstu.",
	"SUPPORT_SELECT_DEP_MSG" => "Izvēlēties departamentu",
	"SUPPORT_SELECT_PROD_MSG" => "Izvēlēties produktu",
	"SUPPORT_SELECT_STATUS_MSG" => "Izvēlēties status",
	"SUPPORT_NOT_VIEWED_MSG" => "Nav skatīts",
	"SUPPORT_VIEWED_BY_USER_MSG" => "Skatījušies klienti",
	"SUPPORT_VIEWED_BY_ADMIN_MSG" => "Skatījušies administratori",
	"SUPPORT_STATUS_NEW_MSG" => "Jauns",
	"NO_SUPPORT_REQUEST_MSG" => "Netika atrasts nekas atbilstošs",

	"SUPPORT_SUMMARY_COLUMN" => "Kopsavilkums",
	"SUPPORT_TYPE_COLUMN" => "Veids",
	"SUPPORT_UPDATED_COLUMN" => "Pēdējo reizi atjaunots",

	"SUPPORT_USER_NAME_FIELD" => "Tavs vārds, uzvārds",
	"SUPPORT_USER_EMAIL_FIELD" => "Tava e-pasta adrese",
	"SUPPORT_IDENTIFIER_FIELD" => "Atpazīstamība (Rēķina Nr)",
	"SUPPORT_ENVIRONMENT_FIELD" => "Vide (operētājsistēma, datu bāze, Web serveris, u.c.)",
	"SUPPORT_DEPARTMENT_FIELD" => "Departaments",
	"SUPPORT_PRODUCT_FIELD" => "Produkts",
	"SUPPORT_TYPE_FIELD" => "Veids",
	"SUPPORT_CURRENT_STATUS_FIELD" => "Patreizējais stāvoklis",
	"SUPPORT_SUMMARY_FIELD" => "Kopsavilkums vienā rindā",
	"SUPPORT_DESCRIPTION_FIELD" => "Apraksts",
	"SUPPORT_MESSAGE_FIELD" => "Ziņa",
	"SUPPORT_ADDED_FIELD" => "Pievienots",
	"SUPPORT_ADDED_BY_FIELD" => "Pievienojis",
	"SUPPORT_UPDATED_FIELD" => "Pēdējo reizi atjaunots",

	"SUPPORT_REQUEST_BUTTON" => "Apstiprināt pieprasījumu",
	                                    
	"SUPPORT_MISS_ID_ERROR" => "Trūkst <b>Atbalsta ID</b> vērtība",
	"SUPPORT_MISS_CODE_ERROR" => "Trūkst <b>Apstripinājuma</b> vērtība",
	"SUPPORT_WRONG_ID_ERROR" => "<b>Atbalsta ID</b> ievadītā vērtība nav pareiza",
	"SUPPORT_WRONG_CODE_ERROR" => "<b>Apstiprinājuma</b> ievadītā vērtība nav pareiza",
