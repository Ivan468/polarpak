...
$messages = array(
	...
	"OPTIONAL_MSG" => "Valgfri",
	"RATING_MSG" => "Karakter",
	"BAD_MSG" => "God",
	"POOR_MSG" => "Dårlig",
	"AVERAGE_MSG" => "Mellem",
	"GOOD_MSG" => "God",
	"EXCELLENT_MSG" => "Udmærket",
	"REVIEWS_MSG" => "Anmeldelser ",
	"NO_REVIEWS_MSG" => "Ingen anmeldelser fundet ",
	"WRITE_REVIEW_MSG" => "Skriv en anmeldelse",
	"WRITE_REVIEW_SIGN_IN_MSG" => "Sign in to write a review",
	"RATE_PRODUCT_MSG" => "Vurder produktet",
	"RATE_ARTICLE_MSG" => "Vurder artiklen",
	"NOT_RATED_PRODUCT_MSG" => "Produktet er endnu ikke vurderet",
	"NOT_RATED_ARTICLE_MSG" => "Atiklen er endnu ikke vurderet",
	"AVERAGE_RATING_MSG" => "Gennemsnitlig vurdering",
	"BASED_ON_REVIEWS_MSG" => "baseret på {total_votes} anmeldelser",
	"SEE_ALL_REVIEWS_MSG" => "Se alle kundeanmeldelser",
	"ALL_REVIEWS_MSG" => "Alle anmeldelser",
	"ONLY_POSITIVE_MSG" => "Kun positive",
	"ONLY_NEGATIVE_MSG" => "Kun negative ",
	"POSITIVE_REVIEWS_MSG" => "Positive anmeldelser",
	"NEGATIVE_REVIEWS_MSG" => "Negative anmeldelser",
	"NEUTRAL_REVIEWS_MSG" => "Neutral Reviews",
	"REVIEW_SAVED_MSG" => "Thank you, your review has been saved.",
	"REVIEW_SAVED_FOR_APPROVAL_MSG" => "Mange tak<br>Dine kommentarer vil blive læst og hvis de er i overensstemmelse med vores retningslinjer vil de blive gjort tilgængelige på sitet.",
	"ALREADY_REVIEWED_MSG" => "Du har allerede anmeldt",
	"ALREADY_REVIEWED_PRODUCT_MSG" => "You have already placed a review for this product.",
	"RECOMMEND_PRODUCT_MSG" => "Vil du anbefale <br>produktet til andre?",
	"RECOMMEND_ARTICLE_MSG" => "Vil du anbefale <br>artiklen til andre?",
	...
	"RATE_IT_MSG" => "Vurder",
	"NAME_ALIAS_MSG" => "Navn eller pseudonym",
	...
	"NO_QUESTIONS_MSG" => "Ingen spørgsmål blev ikke fundet",
	...
	"QUESTION_SAVED_FOR_APPROVAL_MSG" => "Mange tak<br>Dine kommentarer vil blive læst og hvis de er i overensstemmelse med vores retningslinjer vil de blive gjort tilgængelige på sitet.",
	"ALREADY_ASKED_MSG" => "Du har allerede anmeldt",
