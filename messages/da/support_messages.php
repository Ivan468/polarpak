...
$messages = array(
	...
	"SUPPORT_REQUEST_INF_TITLE" => "Anmod om information",
	"SUPPORT_REPLY_FORM_TITLE" => "Svar",
	"SUPPORT_SHORT_TITLE" => "Support",

	"MY_SUPPORT_ISSUES_MSG" => "Mine support henvendelser",
	"MY_SUPPORT_ISSUES_DESC" => "Hvis du oplever nogle problemer med de produkter du har købt, er vi klar til hjælpe. Venligt kontakt os på ved at klikke på ovenstående link for at sende en hjælpe forespørgsel.",
	"NEW_SUPPORT_REQUEST_MSG" => "Ny henvendelse",
	"SUPPORT_REQUEST_ADDED_MSG" => "Mange tak<br>Vi behandler din forespørgsel og kontakter dig dig så hurtigt som muligt. ",
	"SUPPORT_SELECT_DEP_MSG" => "Vælg Afdeling",
	"SUPPORT_SELECT_PROD_MSG" => "Vælg Type",
	"SUPPORT_SELECT_STATUS_MSG" => "Se",
	"SUPPORT_NOT_VIEWED_MSG" => "Ikke set",
	"SUPPORT_VIEWED_BY_USER_MSG" => "Set af bruger",
	"SUPPORT_VIEWED_BY_ADMIN_MSG" => "Set af administrator",
	"SUPPORT_STATUS_NEW_MSG" => "Ny",
	"NO_SUPPORT_REQUEST_MSG" => "Ingen sager fundet",

	"SUPPORT_SUMMARY_COLUMN" => "Status",
	"SUPPORT_TYPE_COLUMN" => "Type",
	"SUPPORT_UPDATED_COLUMN" => "Sidst opdateret",

	"SUPPORT_USER_NAME_FIELD" => "Dit navn",
	"SUPPORT_USER_EMAIL_FIELD" => "Din e-mail-adresse",
	"SUPPORT_IDENTIFIER_FIELD" => "Identifikator (Faktura #)",
	"SUPPORT_ENVIRONMENT_FIELD" => "Miljø (OS, database, web server, etc.)",
	"SUPPORT_DEPARTMENT_FIELD" => "Afdeling",
	"SUPPORT_PRODUCT_FIELD" => "Produkt",
	"SUPPORT_TYPE_FIELD" => "Status",
	"SUPPORT_CURRENT_STATUS_FIELD" => "Aktuel status",
	"SUPPORT_SUMMARY_FIELD" => "Én-linjes resumé",
	"SUPPORT_DESCRIPTION_FIELD" => "Beskrivelse",
	"SUPPORT_MESSAGE_FIELD" => "Besked",
	"SUPPORT_ADDED_FIELD" => "Tilføjet",
	"SUPPORT_ADDED_BY_FIELD" => "Tilføjet af",
	"SUPPORT_UPDATED_FIELD" => "Senest opdateret",

	"SUPPORT_REQUEST_BUTTON" => "Send henvendelse",
	                                    
	"SUPPORT_MISS_ID_ERROR" => "Mangler <b> Support ID</b> parameter",
	"SUPPORT_MISS_CODE_ERROR" => "Mangler <b> verificering</b> parameter",
	"SUPPORT_WRONG_ID_ERROR" => "<b> Support ID</b> paramter har forkert værdi",
	"SUPPORT_WRONG_CODE_ERROR" => "<b>Verificering<b/> parameter har forkert værdi ",

	"MAIL_DATA_MSG" => "Mail Data",
	"HEADERS_MSG" => "Overskrifter",
	"ORIGINAL_TEXT_MSG" => "Originaltekst",
