...
$messages = array(
	...
	"SUPPORT_REQUEST_INF_TITLE" => "Solicitar informações",
	"SUPPORT_REPLY_FORM_TITLE" => "Responder",
	"SUPPORT_SHORT_TITLE" => "Support",

	"MY_SUPPORT_ISSUES_MSG" => "Minhas solicitações de suporte",
	"MY_SUPPORT_ISSUES_DESC" => "Se você tiver problemas com algum produto comprado conosco, nossa equipe de suporte esta a disposição para ajudà-lo. Clique no link acima para solicitar suporte.",
	"NEW_SUPPORT_REQUEST_MSG" => "Nova solicitação",
	"SUPPORT_REQUEST_ADDED_MSG" => "Obrigado<br>Nossa equipe de suporte entrará em contato em até 1 dia útil.",
	"SUPPORT_SELECT_DEP_MSG" => "Escolher departamento",
	"SUPPORT_SELECT_PROD_MSG" => "Selecionar produto",
	"SUPPORT_SELECT_STATUS_MSG" => "Selecionar situação",
	"SUPPORT_NOT_VIEWED_MSG" => "Não Visualizado",
	"SUPPORT_VIEWED_BY_USER_MSG" => "Visualizado pelo usuário",
	"SUPPORT_VIEWED_BY_ADMIN_MSG" => "Visualizado pelo administrador",
	"SUPPORT_STATUS_NEW_MSG" => "Novo",
	"NO_SUPPORT_REQUEST_MSG" => "Nenhuma solicitação de suporte foi encontrada",

	"SUPPORT_SUMMARY_COLUMN" => "Sumàrio",
	"SUPPORT_TYPE_COLUMN" => "Tipo",
	"SUPPORT_UPDATED_COLUMN" => "Ultima atualização",

	"SUPPORT_USER_NAME_FIELD" => "Seu nome",
	"SUPPORT_USER_EMAIL_FIELD" => "Seu email",
	"SUPPORT_IDENTIFIER_FIELD" => "Identificador (Nº da fatura)",
	"SUPPORT_ENVIRONMENT_FIELD" => "Ambiente (OS, Banco de dados, Web Server, etc.)",
	"SUPPORT_DEPARTMENT_FIELD" => "Departamento",
	"SUPPORT_PRODUCT_FIELD" => "Produto",
	"SUPPORT_TYPE_FIELD" => "Tipo",
	"SUPPORT_CURRENT_STATUS_FIELD" => "Situação atual",
	"SUPPORT_SUMMARY_FIELD" => "Sumàrio online",
	...
	"SUPPORT_UPDATED_FIELD" => "Ultima atualização",

	"SUPPORT_REQUEST_BUTTON" => "Submeter solicitação",
	                                    
	"SUPPORT_MISS_ID_ERROR" => "Parâmeto  de <b>Identificador de suporte </b> faltando",
	"SUPPORT_MISS_CODE_ERROR" => "Parâmeto  de <b>Verificação</b> faltando",
	"SUPPORT_WRONG_ID_ERROR" => "O parâmeto <b>Identificador de suporte </b> possui um valor incorreto",
	"SUPPORT_WRONG_CODE_ERROR" => "O parâmeto <b>Verificação </b> possui um valor incorreto",

	"MAIL_DATA_MSG" => "Dados de email",
	"HEADERS_MSG" => "Headers",
