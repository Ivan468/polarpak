...
$messages = array(
	...
	"REVIEWS_MSG" => "Teste",
	"NO_REVIEWS_MSG" => "Sem teste",
	"WRITE_REVIEW_MSG" => "Escrever um teste",
	"WRITE_REVIEW_SIGN_IN_MSG" => "Sign in to write a review",
	"RATE_PRODUCT_MSG" => "Avalie este produto",
	"RATE_ARTICLE_MSG" => "Avalie este artigo",
	"NOT_RATED_PRODUCT_MSG" => "Produto ainda não avaliado",
	"NOT_RATED_ARTICLE_MSG" => "Artigo ainda não avaliado",
	"AVERAGE_RATING_MSG" => "Avaliação média",
	"BASED_ON_REVIEWS_MSG" => "baseado em {total_votes} testes",
	"SEE_ALL_REVIEWS_MSG" => "Ver todos os testes de clientes",
	"ALL_REVIEWS_MSG" => "Todos os testes",
	"ONLY_POSITIVE_MSG" => "Somente positiva",
	"ONLY_NEGATIVE_MSG" => "Somente negativa",
	"POSITIVE_REVIEWS_MSG" => "Testes positivos",
	"NEGATIVE_REVIEWS_MSG" => "Testes negativos",
	"NEUTRAL_REVIEWS_MSG" => "Neutral Reviews",
	"REVIEW_SAVED_MSG" => "Thank you, your review has been saved.",
	"REVIEW_SAVED_FOR_APPROVAL_MSG" => "Obrigado<br>Seus comentarios serão revistos. Se aprovados serão mostrados no site.<br>Nos reservamos o direito de declinar algumas submissões que não atendam nossa linha editorial.",
	"ALREADY_REVIEWED_MSG" => "Você já fez um teste",
	"ALREADY_REVIEWED_PRODUCT_MSG" => "You have already placed a review for this product.",
	"RECOMMEND_PRODUCT_MSG" => "Você recomendaria<br>esse produto para outros?",
	"RECOMMEND_ARTICLE_MSG" => "Você recomendaria<br>esse artigo para outros?",
	...
	"RATE_IT_MSG" => "Avalie",
	"NAME_ALIAS_MSG" => "Nome ou Apelido",
	...
	"NO_QUESTIONS_MSG" => "Nenhuma pergunta foi encontrada",
	...
	"QUESTION_SAVED_FOR_APPROVAL_MSG" => "Obrigado<br>Seus comentarios serão revistos. Se aprovados serão mostrados no site.<br>Nos reservamos o direito de declinar algumas submissões que não atendam nossa linha editorial.",
	"ALREADY_ASKED_MSG" => "Você já fez um teste",
