...
$messages = array(
	...
	"OPTIONAL_MSG" => "Valinnainen",
	"RATING_MSG" => "Rating",
	"BAD_MSG" => "Todella huono",
	"POOR_MSG" => "Huono",
	"AVERAGE_MSG" => "Keskinkertainen",
	"GOOD_MSG" => "Hyvä",
	"EXCELLENT_MSG" => "Erinomainen",
	"REVIEWS_MSG" => "Arvostelut",
	"NO_REVIEWS_MSG" => "Arvosteluja ei löytynyt",
	"WRITE_REVIEW_MSG" => "Kirjoita arvostelu",
	"WRITE_REVIEW_SIGN_IN_MSG" => "Sign in to write a review",
	"RATE_PRODUCT_MSG" => "Arvostele tämä tuote",
	"RATE_ARTICLE_MSG" => "Arvostele tämä artikkeli",
	"NOT_RATED_PRODUCT_MSG" => "Tätä tuotetta ei vielä ole arvosteltu",
	"NOT_RATED_ARTICLE_MSG" => "Artikkelia ole ole vielä arvosteltu",
	"AVERAGE_RATING_MSG" => "Keskiarvo",
	"BASED_ON_REVIEWS_MSG" => "based on {total_votes} reviews.",
	"SEE_ALL_REVIEWS_MSG" => "Katso kaikki arvostelut",
	"ALL_REVIEWS_MSG" => "Kaikki arvostelut",
	"ONLY_POSITIVE_MSG" => "Vain positiviiset",
	"ONLY_NEGATIVE_MSG" => "Vain negatiiviset",
	"POSITIVE_REVIEWS_MSG" => "Positiviiset arvostelut",
	"NEGATIVE_REVIEWS_MSG" => "Negatiiviset arvostelut",
	"NEUTRAL_REVIEWS_MSG" => "Neutral Reviews",
	"REVIEW_SAVED_MSG" => "Thank you, your review has been saved.",
	"REVIEW_SAVED_FOR_APPROVAL_MSG" => "Kiitos!<br>Kommenttisi tarkistetaan.Jos se hyväksytään, se julkaistaan täällä.<br>Pidätämme oikeuden olla julkaisematta kaikkia arvosteluja/kommentteja",
	"ALREADY_REVIEWED_MSG" => "Olet jo tehnyt arvostelun",
	"ALREADY_REVIEWED_PRODUCT_MSG" => "You have already placed a review for this product.",
	"RECOMMEND_PRODUCT_MSG" => "Would you recommend<br> this product to others?",
	"RECOMMEND_ARTICLE_MSG" => "Would you recommend<br> this article to others?",
	...
	"RATE_IT_MSG" => "Arvostele",
	"NAME_ALIAS_MSG" => "Nimi / Lempinimi",
	...
	"NO_QUESTIONS_MSG" => "Ei kysymyksiä",
	...
	"QUESTION_SAVED_FOR_APPROVAL_MSG" => "Kiitos!<br>Kommenttisi tarkistetaan.Jos se hyväksytään, se julkaistaan täällä.<br>Pidätämme oikeuden olla julkaisematta kaikkia arvosteluja/kommentteja",
	"ALREADY_ASKED_MSG" => "Olet jo tehnyt arvostelun",
