...
$messages = array(
	// support messages
	"SUPPORT_TITLE" => "Tuki",
	"SUPPORT_REQUEST_INF_TITLE" => "Pyydä tietoja",
	"SUPPORT_REPLY_FORM_TITLE" => "Vastaa",
	"SUPPORT_SHORT_TITLE" => "Support",

	"MY_SUPPORT_ISSUES_MSG" => "Omat tukipyyntäni",
	"MY_SUPPORT_ISSUES_DESC" => "Jos sinulla on ongelmia tai kysymyksiä ostamastasi tuotteesta, olemme valmiina auttamaan. Klikkaa allaolevaa linkkiä",
	"NEW_SUPPORT_REQUEST_MSG" => "Uusi tukipyyntö",
	"SUPPORT_REQUEST_ADDED_MSG" => "Kiitos!<br>Palaamme asiaan mahdollisimman pian!",
	"SUPPORT_SELECT_DEP_MSG" => "Valitse osasto",
	"SUPPORT_SELECT_PROD_MSG" => "Valitse tuote",
	"SUPPORT_SELECT_STATUS_MSG" => "Valitse tila",
	"SUPPORT_NOT_VIEWED_MSG" => "Ei katsottu",
	"SUPPORT_VIEWED_BY_USER_MSG" => "Asiakas katsonut",
	"SUPPORT_VIEWED_BY_ADMIN_MSG" => "Moderaattori katsonut",
	"SUPPORT_STATUS_NEW_MSG" => "Uusi tukipyyntö",
	"NO_SUPPORT_REQUEST_MSG" => "Pyyntöjä ei löytynyt",

	"SUPPORT_SUMMARY_COLUMN" => "Yhteenveto",
	"SUPPORT_TYPE_COLUMN" => "Tyyppi",
	"SUPPORT_UPDATED_COLUMN" => "Viim. päivitetty",

	"SUPPORT_USER_NAME_FIELD" => "Oma nimesi",
	"SUPPORT_USER_EMAIL_FIELD" => "Sähköpostisi",
	"SUPPORT_IDENTIFIER_FIELD" => "Laskun numero etc",
	"SUPPORT_ENVIRONMENT_FIELD" => "Käyttöympäristö (WIN, MAC, LINUX etc)",
	"SUPPORT_DEPARTMENT_FIELD" => "Osasto",
	"SUPPORT_PRODUCT_FIELD" => "Tuote",
	"SUPPORT_TYPE_FIELD" => "Tyyppi",
	"SUPPORT_CURRENT_STATUS_FIELD" => "Nykyinen tila",
	"SUPPORT_SUMMARY_FIELD" => "Yhden rivin kuvaus",
	"SUPPORT_DESCRIPTION_FIELD" => "Kuvaus",
	"SUPPORT_MESSAGE_FIELD" => "viesti",
	"SUPPORT_ADDED_FIELD" => "Lisätty",
	"SUPPORT_ADDED_BY_FIELD" => "Lisääjä",
	"SUPPORT_UPDATED_FIELD" => "Viim. päivitetty",

	"SUPPORT_REQUEST_BUTTON" => "Lähetä pyynto",
	                                    
	"SUPPORT_MISS_ID_ERROR" => "Puuttuva <b>Tuki ID</b> parametri",
	"SUPPORT_MISS_CODE_ERROR" => "Puuttuva<b>Varmistus</b> parametri",
	"SUPPORT_WRONG_ID_ERROR" => "<b>TUKI ID</b> parametrillä on väärä arvo",
	"SUPPORT_WRONG_CODE_ERROR" => "<b>Varmennus</b> parametrillä on väärä arvo",
