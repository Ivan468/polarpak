...
$messages = array(
	...
	"OPTIONAL_MSG" => "Не обов'язково",
	"RATING_MSG" => "Рейтинг",
	"BAD_MSG" => "Погано",
	"POOR_MSG" => "Бiдно",
	"AVERAGE_MSG" => "Середньо",
	"GOOD_MSG" => "Добре",
	"EXCELLENT_MSG" => "Блискуче",
	"REVIEWS_MSG" => "Вiдгуки",
	"NO_REVIEWS_MSG" => "Немає вiдгукiв",
	"WRITE_REVIEW_MSG" => "Напишiть вiдгук",
	"WRITE_REVIEW_SIGN_IN_MSG" => "Sign in to write a review",
	"RATE_PRODUCT_MSG" => "Оцініть продукт",
	"RATE_ARTICLE_MSG" => "Оцініть статтю",
	"NOT_RATED_PRODUCT_MSG" => "По цьому продукту ще немає вiдгукiв",
	"NOT_RATED_ARTICLE_MSG" => "По цій статті ще немає відгуків",
	"AVERAGE_RATING_MSG" => "Середній рейтинг",
	"BASED_ON_REVIEWS_MSG" => "базується на {total_votes} голосах",
	"SEE_ALL_REVIEWS_MSG" => "Переглянути всi вiдгуки...",
	"ALL_REVIEWS_MSG" => "Всi вiдгуки",
	"ONLY_POSITIVE_MSG" => "Тiльки позитивнi",
	"ONLY_NEGATIVE_MSG" => "Тiльки негативнi",
	"POSITIVE_REVIEWS_MSG" => "Позитивнi вiдгуки",
	"NEGATIVE_REVIEWS_MSG" => "Негативнi вiдгуки",
	"NEUTRAL_REVIEWS_MSG" => "Neutral Reviews",
	"REVIEW_SAVED_MSG" => "Thank you, your review has been saved.",
	"REVIEW_SAVED_FOR_APPROVAL_MSG" => "Дякуємо<br>Ваш відгук невдовзі буде розглянутий i, у разi погодження, з'явиться на нашому сайтi.<br>Ми залишаємо за собою право вiдхилити відгук, який не вiдповiдає нашим правилам чи вимогам.",
	"ALREADY_REVIEWED_MSG" => "Ви вже розмiстили вiдгук.",
	"ALREADY_REVIEWED_PRODUCT_MSG" => "You have already placed a review for this product.",
	"RECOMMEND_PRODUCT_MSG" => "Чи рекомендуєте ви<br> цей продукт iншим?",
	"RECOMMEND_ARTICLE_MSG" => "Чи порекомендуєте ви <br> цю статтю іншим?",
	...
	"RATE_IT_MSG" => "Оцініть",
	"NAME_ALIAS_MSG" => "Iм'я або псевдонiм",
	"YOUR_COMMENTS_MSG" => "Your comments",
	"SHOW_MSG" => "Показати",
	"FOUND_MSG" => "Знайдено",
	"REGISTERED_USERS_ADD_REVIEWS_MSG" => "Тільки зареєстровані користувачі можуть залишати відгуки",
	"NOT_ALLOWED_ADD_REVIEW_MSG" => "Вибачте, Вам не дозволено залишати відгуки ",
	...
	"NO_QUESTIONS_MSG" => "Жодного питання не знайдено",
	...
	"QUESTION_SAVED_FOR_APPROVAL_MSG" => "Дякуємо<br>Ваш відгук невдовзі буде розглянутий i, у разi погодження, з'явиться на нашому сайтi.<br>Ми залишаємо за собою право вiдхилити відгук, який не вiдповiдає нашим правилам чи вимогам.",
	"ALREADY_ASKED_MSG" => "Ви вже розмiстили вiдгук.",
