...
$messages = array(
	...
	"OPTIONAL_MSG" => "Volitelné",
	"RATING_MSG" => "Rating",
	"BAD_MSG" => "Zlý",
	"POOR_MSG" => "Slabý",
	"AVERAGE_MSG" => "Průměrný",
	"GOOD_MSG" => "Dobrý",
	"EXCELLENT_MSG" => "Výborný",
	"REVIEWS_MSG" => "Hodnocení",
	"NO_REVIEWS_MSG" => "Žádné hodnocení nenalezeno",
	"WRITE_REVIEW_MSG" => "Napsát recenzi",
	"WRITE_REVIEW_SIGN_IN_MSG" => "Sign in to write a review",
	"RATE_PRODUCT_MSG" => "Hodnotit tenhle produkt",
	"RATE_ARTICLE_MSG" => "Hodnotit tenhle článek",
	"NOT_RATED_PRODUCT_MSG" => "Produkt ješte není hodnocený",
	"NOT_RATED_ARTICLE_MSG" => "Článek ješte není hodnocený.",
	"AVERAGE_RATING_MSG" => "Průměrné hodnocení",
	"BASED_ON_REVIEWS_MSG" => "založené na {total_votes} recenzích",
	"SEE_ALL_REVIEWS_MSG" => "Zobrazit všechny hodnocení zákazníků",
	"ALL_REVIEWS_MSG" => "Všechny hodnocení",
	"ONLY_POSITIVE_MSG" => "Jenom pozitivní",
	"ONLY_NEGATIVE_MSG" => "Jenom negativní",
	"POSITIVE_REVIEWS_MSG" => "Pozitivní hodnocení",
	"NEGATIVE_REVIEWS_MSG" => "Negativní hodnocení",
	"NEUTRAL_REVIEWS_MSG" => "Neutral Reviews",
	"REVIEW_SAVED_MSG" => "Thank you, your review has been saved.",
	"REVIEW_SAVED_FOR_APPROVAL_MSG" => "Děkujeme<br>Vaše připomínky budou zrevidovány. Pokud přejdou schválením, zobrazí se na naší stránce.<br>Vyhrazujeme si právo nezveřejnit příspěvky nesplňující naše pravidla.",
	"ALREADY_REVIEWED_MSG" => "Už jste vložili recenzi.",
	"ALREADY_REVIEWED_PRODUCT_MSG" => "You have already placed a review for this product.",
	"RECOMMEND_PRODUCT_MSG" => "Doporučili by jste <br> tento produkt jiným?",
	"RECOMMEND_ARTICLE_MSG" => "Doporučili by jste <br> tento článek jiným?",
	...
	"RATE_IT_MSG" => "Hodnotit tenhle produkt",
	"NAME_ALIAS_MSG" => "Jméno nebo alias",
	...
	"NO_QUESTIONS_MSG" => "Žádné otázky nenalezeny",
	...
	"QUESTION_SAVED_FOR_APPROVAL_MSG" => "Děkujeme<br>Vaše připomínky budou zrevidovány. Pokud přejdou schválením, zobrazí se na naší stránce.<br>Vyhrazujeme si právo nezveřejnit příspěvky nesplňující naše pravidla.",
	"ALREADY_ASKED_MSG" => "Už jste vložili recenzi.",
