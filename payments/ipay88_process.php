 ...
 */
	...
	$source = $payment_parameters['MerchantKey'].$payment_parameters['MerchantCode'].$payment_parameters['RefNo'].round($payment_parameters['Amount']*100, 0).$payment_parameters['Currency'];
