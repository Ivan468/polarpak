...
//			if($parameter_name == 'impdafin' || strtolower($parameter_name) == 'impdafin' || preg_match("/parz\d/Uis", $parameter_name)){
			if(preg_match("/impdafin/Uis", $parameter_name) || preg_match("/impspe/Uis", $parameter_name) || preg_match("/anticipo/Uis", $parameter_name) || preg_match("/parz\d/Uis", $parameter_name)){
