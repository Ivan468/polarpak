...
*/
	...
	$parameters = array(
		"name", "first_name", "middle_name", "last_name", "company_id", "company_name", "email",
		"country_id", "state_id",  "province", "city", "address1", "address2", "address3", "zip", 
	...
	$cc_parameters = array(
		...
		"cc_type", "cc_issue_number", "cc_security_code", 
	);
	...
	$call_center_user_parameters = array(
		"user_id", "name", "first_name", "middle_name", "last_name", "company_id", "company_name", "email", 
		"address1", "address2", "address3", "city", "province", "state_id", "zip", "country_id", 
		"phone", "daytime_phone", "evening_phone", "cell_phone", "fax",
		"delivery_name", "delivery_first_name", "delivery_middle_name", "delivery_last_name", "delivery_company_id", 
		"delivery_company_name", "delivery_email", "delivery_address1", "delivery_address2", "delivery_address3", 
