<?php
	...
	$html_template = get_setting_value($block, "html_template", "block_order_payment_form.html"); 
  $t->set_file("block_body", $html_template);

	$default_title = "{CHECKOUT_PAYMENT_TITLE}";
	...
	$r->change_property("cc_security_code", MIN_LENGTH, 2);
	$r->change_property("cc_security_code", MAX_LENGTH, 4);
