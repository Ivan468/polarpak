<?php
	...
	$default_title = "{REGISTER_PRODUCT_MSG}";
	...
	$html_template = get_setting_value($block, "html_template", "block_user_product_registration.html"); 
  $t->set_file("block_body", $html_template);
	...
	$r->set_event(BEFORE_SHOW,  "show_custom_properties", array("pp" => $pp));
