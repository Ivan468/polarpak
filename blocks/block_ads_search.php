<?php
  ...
  $t->set_file("block_body", $html_template);
	...
	$t->set_var("search_name",   va_message("ADS_TITLE"));
	...
	$pass_parameters = array(
		...
		"category_id" => $category_id, "pq" => $pq, "fq" => $fq,
	...
	$search_categories[] = array(0, va_message("SEARCH_IN_ALL_MSG"));
  
	if($category_id != 0) {
		$search_categories[] = array($category_id, va_message("SEARCH_IN_CURRENT_MSG"));
	}
