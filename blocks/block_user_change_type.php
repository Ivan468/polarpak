<?php
	...
	$default_title = "{UPGRADE_DOWNGRADE_MSG}";
	...
	$html_template = get_setting_value($block, "html_template", "block_user_change_type.html"); 
  $t->set_file("block_body", $html_template);
	...
	if(strlen($operation))
	{
		...
		if (!$errors) {
			...
			$is_approved = get_setting_value($user_settings, "edit_account_approve", 0);
