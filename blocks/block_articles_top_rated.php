...
//function articles_top_rated($block_name, $top_id, $top_name)
	...
	$html_template = get_setting_value($block, "html_template", "block_articles_top_rated.html"); 
  $t->set_file("block_body", $html_template);
	...
	if ($db->DBType == "mysql") {
		...
		$params["order"] = " a.rating DESC, a.article_order, a.article_title ";	
	} else {
		$params["group"] = " a.article_id,a.rating,a.article_order,a.article_title ";	
		$params["order"] = " a.rating DESC, a.article_order, a.article_title ";	
	}
