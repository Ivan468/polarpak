<?php
	...
	$html_template = get_setting_value($block, "html_template", "block_user_merchant_orders.html"); 
  $t->set_file("block_body", $html_template);
	...
	$s = new VA_Sorter($settings["templates_dir"], "sorter.html", get_custom_friendly_url("user_merchant_orders.php"));
	...
	$sql .= " AND os.show_for_merchant=1 ";
	if (strtolower($db_type) != "mysql") {
		$sql .= " GROUP BY o.order_id, o.name, o.first_name, o.last_name, o.order_placed_date, os.status_name, o.currency_code, o.currency_rate, ";
