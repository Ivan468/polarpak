<?php
	...
	$default_title = va_message("ADS_SELLERS_TITLE");

	$html_template = get_setting_value($block, "html_template", "block_ads_sellers.html"); 
  $t->set_file("block_body", $html_template);

	$search_tree = new VA_Tree("category_id", "category_name", "parent_category_id", $table_prefix . "ads_categories", "tree", va_message("ADS_TITLE"));
	...
	foreach ($merchants AS $user_id => $merchant){
		...
		$t->set_var("user_href", htmlspecialchars($user_href));
